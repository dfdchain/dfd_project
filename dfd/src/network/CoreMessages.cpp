...
static_assert((int)dfdcore::network::block_message_type == (int)dfdcore::client::block_message_type, "enum values don't match");
static_assert((int)dfdcore::network::trx_message_type == (int)dfdcore::client::trx_message_type, "enum values don't match");
