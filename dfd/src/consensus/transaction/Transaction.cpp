...
namespace dfdcore {
    namespace consensus {
            ...
            uint64_t precision)
        {
            ...
            FC_ASSERT(max_share_supply <= DFD_BLOCKCHAIN_MAX_SHARES, "Max_share_supply must not be bigger than DFD_BLOCKCHAIN_MAX_SHARES!");
        ...
        dfdcore::consensus::ContractIdType Transaction::contract_register(const uvm::blockchain::Code& code, const PublicKeyType& owner, const Asset& initlimit,const Asset& transaction_fee, const map<BalanceIdType, ShareType>& balances)
        {
