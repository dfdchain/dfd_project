...
namespace fc
{
    void to_variant(const dfdcore::consensus::PtsAddress& var, variant& vo)
    {
        vo = std::string(var);
    }
    void from_variant(const variant& var, dfdcore::consensus::PtsAddress& vo)
    {
        vo = dfdcore::consensus::PtsAddress(var.as_string());
    }
}
