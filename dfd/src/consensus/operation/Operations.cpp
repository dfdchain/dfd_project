...
namespace dfdcore {
    namespace consensus {
        ...
        static bool first_chain = []()->bool{
            dfdcore::consensus::OperationFactory::instance().register_operation<WithdrawOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<DepositOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<RegisterAccountOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<UpdateAccountOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<WithdrawPayOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<CreateAssetOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<UpdateAssetOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<IssueAssetOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<DefineSlateOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<ReleaseEscrowOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<UpdateSigningKeyOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<UpdateBalanceVoteOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<UpdateAssetExtOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<ImessageMemoOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<ContractInfoOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<RegisterContractOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<UpgradeContractOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<DestroyContractOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<WithdrawContractOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<TransferContractOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<BalancesWithdrawOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<TransactionOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<StorageOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<CallContractOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<EventOperation>();
            dfdcore::consensus::OperationFactory::instance().register_operation<DepositContractOperation>();
			dfdcore::consensus::OperationFactory::instance().register_operation<OnDestroyOperation>();
			dfdcore::consensus::OperationFactory::instance().register_operation<OnUpgradeOperation>();
			dfdcore::consensus::OperationFactory::instance().register_operation<OnCallSuccessOperation>();
        ...
        void OperationFactory::to_variant(const dfdcore::consensus::Operation& in, fc::variant& output)
        {
            try {
        ...
        void OperationFactory::from_variant(const fc::variant& in, dfdcore::consensus::Operation& output)
        {
            try {
...
namespace fc {
    void to_variant(const dfdcore::consensus::Operation& var, variant& vo)
    {
        dfdcore::consensus::OperationFactory::instance().to_variant(var, vo);
    }

    void from_variant(const variant& var, dfdcore::consensus::Operation& vo)
    {
        dfdcore::consensus::OperationFactory::instance().from_variant(var, vo);
    }
}
