    ...
    namespace consensus {
        ...
        void AssetEntry::sanity_check(const ChainInterface& db)const
        {
            try {
                ...
                FC_ASSERT(maximum_share_supply >= 0 && maximum_share_supply <= DFD_BLOCKCHAIN_MAX_SHARES, "Invalid max supply");
                ...
                FC_ASSERT(market_fee <= DFD_BLOCKCHAIN_MAX_UIA_MARKET_FEE, "Invalid market fee");
