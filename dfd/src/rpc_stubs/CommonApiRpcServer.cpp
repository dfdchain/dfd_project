...
//          generator (dfdcore_api_generator.cpp) itself
//
...
namespace dfdcore {
	namespace rpc_stubs {
		...
		fc::variant CommonApiRpcServer::blockchain_get_dfd_account_balance_entry_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			// this method has no prerequisites
			...
			std::vector<dfdcore::consensus::DfdTrxidBalance> result = get_client()->blockchain_get_dfd_account_balance_entry(block_num);
			return fc::variant(result);
		}

		fc::variant CommonApiRpcServer::blockchain_get_dfd_account_balance_entry_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			// this method has no prerequisites
		...
		fc::variant CommonApiRpcServer::blockchain_calculate_supply_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::Asset result = get_client()->blockchain_calculate_supply(asset);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_get_security_state_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::BlockchainSecurityState result = get_client()->blockchain_get_security_state();
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_list_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::AccountEntry> result = get_client()->blockchain_list_accounts(first_account_name, limit);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_list_recently_updated_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::AccountEntry> result = get_client()->blockchain_list_recently_updated_accounts();
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_list_recently_registered_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::AccountEntry> result = get_client()->blockchain_list_recently_registered_accounts();
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_list_assets_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::AssetEntry> result = get_client()->blockchain_list_assets(first_symbol, limit);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_list_pending_transactions_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<std::pair<dfdcore::consensus::TransactionIdType, dfdcore::consensus::SignedTransaction>> result = get_client()->blockchain_list_pending_transactions();
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_get_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::pair<dfdcore::consensus::TransactionIdType, dfdcore::consensus::TransactionEntry> result = get_client()->blockchain_get_transaction(transaction_id_prefix, exact);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_get_pretty_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::PrettyTransaction result = get_client()->blockchain_get_pretty_transaction(transaction_id_prefix, exact);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_get_pretty_contract_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::PrettyContractTransaction result = get_client()->blockchain_get_pretty_contract_transaction(transaction_id_prefix, exact);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_get_block_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			fc::optional<dfdcore::consensus::BlockEntry> result = get_client()->blockchain_get_block(block);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_get_block_transactions_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::map<dfdcore::consensus::TransactionIdType, dfdcore::consensus::TransactionEntry> result = get_client()->blockchain_get_block_transactions(block);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_get_account_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			fc::optional<dfdcore::consensus::AccountEntry> result = get_client()->blockchain_get_account(account);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_get_slate_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::map<dfdcore::consensus::AccountIdType, std::string> result = get_client()->blockchain_get_slate(slate);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_get_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::Address balance_id = parameters[0].as<dfdcore::consensus::Address>();

			dfdcore::consensus::BalanceEntry result = get_client()->blockchain_get_balance(balance_id);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_get_balance_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::Address balance_id = parameters["balance_id"].as<dfdcore::consensus::Address>();
		...
		fc::variant CommonApiRpcServer::blockchain_list_balances_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::unordered_map<dfdcore::consensus::BalanceIdType, dfdcore::consensus::BalanceEntry> result = get_client()->blockchain_list_balances(first_balance_id, limit);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_list_address_balances_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::unordered_map<dfdcore::consensus::BalanceIdType, dfdcore::consensus::BalanceEntry> result = get_client()->blockchain_list_address_balances(addr, chanced_since);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_get_account_public_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::AccountBalanceSummaryType result = get_client()->blockchain_get_account_public_balance(account_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_list_key_balances_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::PublicKeyType key = parameters[0].as<dfdcore::consensus::PublicKeyType>();

			std::unordered_map<dfdcore::consensus::BalanceIdType, dfdcore::consensus::BalanceEntry> result = get_client()->blockchain_list_key_balances(key);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_list_key_balances_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::PublicKeyType key = parameters["key"].as<dfdcore::consensus::PublicKeyType>();
		...
		fc::variant CommonApiRpcServer::blockchain_get_asset_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			fc::optional<dfdcore::consensus::AssetEntry> result = get_client()->blockchain_get_asset(asset);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_list_active_delegates_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
            ...
            std::vector<dfdcore::consensus::AccountEntry> result = get_client()->blockchain_list_active_delegates(first, count);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::blockchain_list_delegates_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
			...
			std::vector<dfdcore::consensus::AccountEntry> result = get_client()->blockchain_list_delegates(first, count);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_list_blocks_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::BlockEntry> result = get_client()->blockchain_list_blocks(max_block_num, limit);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_export_fork_graph_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			uint32_t end_block = (parameters.size() <= 1) ?
				(fc::json::from_string("-1").as<uint32_t>()) :
				parameters[1].as<uint32_t>();
			dfdcore::consensus::FilePath filename = (parameters.size() <= 2) ?
				(fc::json::from_string("\"\"").as<dfdcore::consensus::FilePath>()) :
				parameters[2].as<dfdcore::consensus::FilePath>();
		...
		fc::variant CommonApiRpcServer::blockchain_export_fork_graph_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::FilePath filename = parameters.contains("filename") ?
				(fc::json::from_string("\"\"").as<dfdcore::consensus::FilePath>()) :
				parameters["filename"].as<dfdcore::consensus::FilePath>();
		...
		fc::variant CommonApiRpcServer::blockchain_list_forks_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::map<uint32_t, std::vector<dfdcore::consensus::ForkEntry>> result = get_client()->blockchain_list_forks();
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_get_delegate_slot_entrys_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::SlotEntry> result = get_client()->blockchain_get_delegate_slot_entrys(delegate_name, limit);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_unclaimed_genesis_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::Asset result = get_client()->blockchain_unclaimed_genesis();
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::blockchain_broadcast_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::SignedTransaction trx = parameters[0].as<dfdcore::consensus::SignedTransaction>();
		...
		fc::variant CommonApiRpcServer::blockchain_broadcast_transaction_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::SignedTransaction trx = parameters["trx"].as<dfdcore::consensus::SignedTransaction>();
		...
		fc::variant CommonApiRpcServer::blockchain_list_contract_transaction_history_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::wallet::ContractTransactionSummary> result = get_client()->blockchain_list_contract_transaction_history(from_block_num, block_count, contract_id, trx_type, call_method);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::network_broadcast_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::SignedTransaction transaction_to_broadcast = parameters[0].as<dfdcore::consensus::SignedTransaction>();

			dfdcore::consensus::TransactionIdType result = get_client()->network_broadcast_transaction(transaction_to_broadcast);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::network_broadcast_transaction_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::SignedTransaction transaction_to_broadcast = parameters["transaction_to_broadcast"].as<dfdcore::consensus::SignedTransaction>();
		...
		fc::variant CommonApiRpcServer::network_get_transaction_propagation_data_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::TransactionIdType transaction_id = parameters[0].as<dfdcore::consensus::TransactionIdType>();

			dfdcore::network::MessagePropagationData result = get_client()->network_get_transaction_propagation_data(transaction_id);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::network_get_transaction_propagation_data_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::TransactionIdType transaction_id = parameters["transaction_id"].as<dfdcore::consensus::TransactionIdType>();
		...
		fc::variant CommonApiRpcServer::network_get_block_propagation_data_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::BlockIdType block_hash = parameters[0].as<dfdcore::consensus::BlockIdType>();

			dfdcore::network::MessagePropagationData result = get_client()->network_get_block_propagation_data(block_hash);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::network_get_block_propagation_data_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::BlockIdType block_hash = parameters["block_hash"].as<dfdcore::consensus::BlockIdType>();
		...
		fc::variant CommonApiRpcServer::network_list_potential_peers_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::network::PotentialPeerEntry> result = get_client()->network_list_potential_peers();
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::delegate_blacklist_add_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::TransactionIdType id = parameters[0].as<dfdcore::consensus::TransactionIdType>();
		...
		fc::variant CommonApiRpcServer::delegate_blacklist_add_transaction_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::TransactionIdType id = parameters["id"].as<dfdcore::consensus::TransactionIdType>();
		...
		fc::variant CommonApiRpcServer::delegate_blacklist_add_operation_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			if (parameters.size() <= 0)
				FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 1 (id)");
			dfdcore::consensus::OperationTypeEnum id = parameters[0].as<dfdcore::consensus::OperationTypeEnum>();
		...
		fc::variant CommonApiRpcServer::delegate_blacklist_add_operation_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			if (!parameters.contains("id"))
				FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'id'");
			dfdcore::consensus::OperationTypeEnum id = parameters["id"].as<dfdcore::consensus::OperationTypeEnum>();
		...
		fc::variant CommonApiRpcServer::wallet_account_transaction_history_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::wallet::PrettyTransaction> result = get_client()->wallet_account_transaction_history(account_name, asset_symbol, limit, start_block_num, end_block_num);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_transaction_history_splite_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::wallet::PrettyTransaction> result = get_client()->wallet_transaction_history_splite(account_name, asset_symbol, limit, transaction_type);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_account_historic_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::AccountBalanceSummaryType result = get_client()->wallet_account_historic_balance(time, account_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_get_pending_transaction_errors_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::FilePath filename = (parameters.size() <= 0) ?
				(fc::json::from_string("\"\"").as<dfdcore::consensus::FilePath>()) :
				parameters[0].as<dfdcore::consensus::FilePath>();

			std::map<dfdcore::consensus::TransactionIdType, fc::exception> result = get_client()->wallet_get_pending_transaction_errors(filename);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_account_create_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::Address result = get_client()->wallet_account_create(account_name, private_data);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_get_all_approved_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::AccountEntry> result = get_client()->wallet_get_all_approved_accounts(approval);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_transfer_to_address_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::Imessage memo_message = (parameters.size() <= 4) ?
				(fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>()) :
				parameters[4].as<dfdcore::consensus::Imessage>();
			dfdcore::wallet::VoteStrategy strategy = (parameters.size() <= 5) ?
				(fc::json::from_string("\"vote_recommended\"").as<dfdcore::wallet::VoteStrategy>()) :
				parameters[5].as<dfdcore::wallet::VoteStrategy>();

			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_transfer_to_address(amount_to_transfer, asset_symbol, from_account_name, to_address, memo_message, strategy);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_transfer_to_address_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::Imessage memo_message = parameters.contains("memo_message") ?
				(fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>()) :
				parameters["memo_message"].as<dfdcore::consensus::Imessage>();
			dfdcore::wallet::VoteStrategy strategy = parameters.contains("strategy") ?
				(fc::json::from_string("\"vote_recommended\"").as<dfdcore::wallet::VoteStrategy>()) :
				parameters["strategy"].as<dfdcore::wallet::VoteStrategy>();
		...
		fc::variant CommonApiRpcServer::wallet_transfer_to_public_account_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_transfer_to_public_account(amount_to_transfer, asset_symbol, from_account_name, to_account_name, memo_message, strategy);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_withdraw_from_address_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::Address from_address = parameters[2].as<dfdcore::consensus::Address>();
			if (parameters.size() <= 3)
				FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 4 (to)");
			std::string to = parameters[3].as<std::string>();
			dfdcore::wallet::VoteStrategy strategy = (parameters.size() <= 4) ?
				(fc::json::from_string("\"vote_none\"").as<dfdcore::wallet::VoteStrategy>()) :
				parameters[4].as<dfdcore::wallet::VoteStrategy>();
			...
			dfdcore::wallet::TransactionBuilder result = get_client()->wallet_withdraw_from_address(amount, symbol, from_address, to, strategy, sign_and_broadcast, builder_path);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_withdraw_from_address_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::Address from_address = parameters["from_address"].as<dfdcore::consensus::Address>();
		...
		fc::variant CommonApiRpcServer::wallet_get_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_get_transaction(transaction_id);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_scan_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_scan_transaction(transaction_id, overwrite_existing);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_account_register_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_account_register(account_name, pay_from_account, public_data, delegate_pay_rate, account_type);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_account_update_registration_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_account_update_registration(account_name, pay_from_account, public_data, delegate_pay_rate);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_account_update_active_key_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_account_update_active_key(account_to_update, pay_from_account, new_active_key);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_list_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::wallet::WalletAccountEntry> result = get_client()->wallet_list_accounts();
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_list_unregistered_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::wallet::WalletAccountEntry> result = get_client()->wallet_list_unregistered_accounts();
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_list_my_accounts_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::wallet::WalletAccountEntry> result = get_client()->wallet_list_my_accounts();
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_list_my_addresses_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::wallet::AccountAddressData> result = get_client()->wallet_list_my_addresses();
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_get_account_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletAccountEntry result = get_client()->wallet_get_account(account_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_asset_create_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_asset_create(symbol, asset_name, issuer_name, description, maximum_share_supply, precision, public_data, is_market_issued);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_asset_issue_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::Imessage memo_message = (parameters.size() <= 3) ?
				(fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>()) :
				parameters[3].as<dfdcore::consensus::Imessage>();

			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_asset_issue(amount, symbol, to_account_name, memo_message);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_asset_issue_to_addresses_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::map<std::string, dfdcore::consensus::ShareType> addresses = parameters[1].as<std::map<std::string, dfdcore::consensus::ShareType>>();

			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_asset_issue_to_addresses(symbol, addresses);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_asset_issue_to_addresses_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			std::map<std::string, dfdcore::consensus::ShareType> addresses = parameters["addresses"].as<std::map<std::string, dfdcore::consensus::ShareType>>();
		...
		fc::variant CommonApiRpcServer::wallet_account_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::AccountBalanceSummaryType result = get_client()->wallet_account_balance(account_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_account_balance_ids_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::AccountBalanceIdSummaryType result = get_client()->wallet_account_balance_ids(account_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_account_list_public_keys_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::wallet::PublicKeySummary> result = get_client()->wallet_account_list_public_keys(account_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_delegate_withdraw_pay_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_delegate_withdraw_pay(delegate_name, to_account_name, amount_to_withdraw);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_delegate_pay_balance_query_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::DelegatePaySalary result = get_client()->wallet_delegate_pay_balance_query(delegate_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_active_delegate_salary_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::map<std::string, dfdcore::consensus::DelegatePaySalary> result = get_client()->wallet_active_delegate_salary();
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_set_transaction_fee_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::Asset result = get_client()->wallet_set_transaction_fee(fee);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_get_transaction_fee_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::Asset result = get_client()->wallet_get_transaction_fee(symbol);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_dump_account_private_key_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::AccountKeyType key_type = parameters[1].as<dfdcore::wallet::AccountKeyType>();
		...
		fc::variant CommonApiRpcServer::wallet_dump_account_private_key_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::wallet::AccountKeyType key_type = parameters["key_type"].as<dfdcore::wallet::AccountKeyType>();
		...
		fc::variant CommonApiRpcServer::wallet_account_vote_summary_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::AccountVoteSummaryType result = get_client()->wallet_account_vote_summary(account_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_check_vote_status_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::VoteSummary result = get_client()->wallet_check_vote_status(account);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_login_finish_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::PublicKeyType server_key = parameters[0].as<dfdcore::consensus::PublicKeyType>();
			if (parameters.size() <= 1)
				FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 2 (client_key)");
			dfdcore::consensus::PublicKeyType client_key = parameters[1].as<dfdcore::consensus::PublicKeyType>();
			if (parameters.size() <= 2)
		...
		fc::variant CommonApiRpcServer::wallet_login_finish_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::PublicKeyType server_key = parameters["server_key"].as<dfdcore::consensus::PublicKeyType>();
			if (!parameters.contains("client_key"))
				FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'client_key'");
			dfdcore::consensus::PublicKeyType client_key = parameters["client_key"].as<dfdcore::consensus::PublicKeyType>();
		...
		fc::variant CommonApiRpcServer::wallet_balance_set_vote_info_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::string voter_address = (parameters.size() <= 1) ?
				(fc::json::from_string("\"\"").as<std::string>()) :
				parameters[1].as<std::string>();
			dfdcore::wallet::VoteStrategy strategy = (parameters.size() <= 2) ?
				(fc::json::from_string("\"vote_all\"").as<dfdcore::wallet::VoteStrategy>()) :
				parameters[2].as<dfdcore::wallet::VoteStrategy>();
			...
			dfdcore::wallet::TransactionBuilder result = get_client()->wallet_balance_set_vote_info(balance_id, voter_address, strategy, sign_and_broadcast, builder_path);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_publish_slate_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_publish_slate(publishing_account_name, paying_account_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_publish_version_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_publish_version(publishing_account_name, paying_account_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_collect_genesis_balances_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_collect_genesis_balances(account_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_account_retract_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_account_retract(account_to_retract, pay_from_account);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_get_account_owner_publickey_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::PublicKeyType result = get_client()->wallet_get_account_owner_publickey(account_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_transfer_to_contract_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_transfer_to_contract(amount_to_transfer, asset_symbol, from_account_name, to_contract, amount_for_exec);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_transfer_to_contract_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::Asset> result = get_client()->wallet_transfer_to_contract_testing(amount_to_transfer, asset_symbol, from_account_name, to_contract);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_builder_add_signature_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::TransactionBuilder builder = parameters[0].as<dfdcore::wallet::TransactionBuilder>();
			bool broadcast = (parameters.size() <= 1) ?
				(fc::json::from_string("false").as<bool>()) :
				parameters[1].as<bool>();

			dfdcore::wallet::TransactionBuilder result = get_client()->wallet_builder_add_signature(builder, broadcast);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_builder_add_signature_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::wallet::TransactionBuilder builder = parameters["builder"].as<dfdcore::wallet::TransactionBuilder>();
        ...
        fc::variant CommonApiRpcServer::wallet_builder_file_add_signature_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
			...
			dfdcore::consensus::FilePath builder_path = parameters[0].as<dfdcore::consensus::FilePath>();
			bool broadcast = (parameters.size() <= 1) ?
				(fc::json::from_string("false").as<bool>()) :
				parameters[1].as<bool>();

			dfdcore::wallet::TransactionBuilder result = get_client()->wallet_builder_file_add_signature(builder_path, broadcast);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_builder_file_add_signature_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::FilePath builder_path = parameters["builder_path"].as<dfdcore::consensus::FilePath>();
			bool broadcast = parameters.contains("broadcast") ?
				(fc::json::from_string("false").as<bool>()) :
				parameters["broadcast"].as<bool>();
        ...
        fc::variant CommonApiRpcServer::wallet_multisig_deposit_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_multisig_deposit(amount, asset_symbol, from_account, to_account, memo_message);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_import_multisig_account_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::Address multisig_address = parameters[0].as<dfdcore::consensus::Address>();
		...
		fc::variant CommonApiRpcServer::wallet_import_multisig_account_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::Address multisig_address = parameters["multisig_address"].as<dfdcore::consensus::Address>();
		...
		fc::variant CommonApiRpcServer::wallet_import_multisig_account_by_detail_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::Address> addresses = parameters[2].as<std::vector<dfdcore::consensus::Address>>();

			dfdcore::consensus::Address result = get_client()->wallet_import_multisig_account_by_detail(asset_symbol, m, addresses);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_import_multisig_account_by_detail_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			if (!parameters.contains("addresses"))
				FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'addresses'");
			std::vector<dfdcore::consensus::Address> addresses = parameters["addresses"].as<std::vector<dfdcore::consensus::Address>>();
		...
		fc::variant CommonApiRpcServer::wallet_multisig_withdraw_start_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::Address from = parameters[2].as<dfdcore::consensus::Address>();
			if (parameters.size() <= 3)
				FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 4 (to_address)");
			dfdcore::consensus::Address to_address = parameters[3].as<dfdcore::consensus::Address>();
			dfdcore::consensus::Imessage memo_message = (parameters.size() <= 4) ?
				(fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>()) :
				parameters[4].as<dfdcore::consensus::Imessage>();
			dfdcore::consensus::FilePath builder_path = (parameters.size() <= 5) ?
				(fc::json::from_string("\"\"").as<dfdcore::consensus::FilePath>()) :
				parameters[5].as<dfdcore::consensus::FilePath>();

			dfdcore::wallet::TransactionBuilder result = get_client()->wallet_multisig_withdraw_start(amount, asset_symbol, from, to_address, memo_message, builder_path);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_multisig_withdraw_start_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::Address from = parameters["from"].as<dfdcore::consensus::Address>();
			if (!parameters.contains("to_address"))
				FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'to_address'");
			dfdcore::consensus::Address to_address = parameters["to_address"].as<dfdcore::consensus::Address>();
			dfdcore::consensus::Imessage memo_message = parameters.contains("memo_message") ?
				(fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>()) :
				parameters["memo_message"].as<dfdcore::consensus::Imessage>();
			dfdcore::consensus::FilePath builder_path = parameters.contains("builder_path") ?
				(fc::json::from_string("\"\"").as<dfdcore::consensus::FilePath>()) :
				parameters["builder_path"].as<dfdcore::consensus::FilePath>();
		...
		fc::variant CommonApiRpcServer::wallet_create_multisig_account_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::Address> addresses = parameters[4].as<std::vector<dfdcore::consensus::Address>>();
			dfdcore::consensus::Imessage memo_message = (parameters.size() <= 5) ?
				(fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>()) :
				parameters[5].as<dfdcore::consensus::Imessage>();

			std::pair<std::string, dfdcore::wallet::WalletTransactionEntry> result = get_client()->wallet_create_multisig_account(amount, asset_symbol, from_account, m, addresses, memo_message);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_multisig_account_history_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::wallet::PrettyTransaction> result = get_client()->wallet_multisig_account_history(account_address, asset_symbol, limit, start_block_num, end_block_num);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_multisig_account_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::AccountBalanceSummaryType result = get_client()->wallet_multisig_account_balance(account_address);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::wallet_builder_get_multisig_detail_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::TransactionBuilder transaction_builder = parameters[0].as<dfdcore::wallet::TransactionBuilder>();
		...
		fc::variant CommonApiRpcServer::wallet_builder_get_multisig_detail_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::wallet::TransactionBuilder transaction_builder = parameters["transaction_builder"].as<dfdcore::wallet::TransactionBuilder>();
        ...
        fc::variant CommonApiRpcServer::builder_finalize_and_sign_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            dfdcore::wallet::WalletTransactionEntry result = get_client()->builder_finalize_and_sign(builder);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::meta_help_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            std::map<std::string, dfdcore::api::MethodData> result = get_client()->meta_help();
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_transfer_to_address_build_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_transfer_to_address_build(amount_to_transfer, asset_symbol, from_account_public_key, to_address, memo_message, strategy);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_transfer_to_contract_build_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_transfer_to_contract_build(amount_to_transfer, asset_symbol, from_account_public_key, to_contract, amount_for_exec);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::wallet_call_contract_build_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            dfdcore::wallet::WalletTransactionEntry result = get_client()->wallet_call_contract_build(contract, caller_publickey, function_name, params, asset_symbol, call_limit);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sign_build_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
        {
            ...
            dfdcore::wallet::WalletTransactionEntry trasaction_building = parameters[0].as<dfdcore::wallet::WalletTransactionEntry>();

            dfdcore::wallet::WalletTransactionEntry result = get_client()->sign_build_transaction(trasaction_building);
            return fc::variant(result);
        }
        ...
        fc::variant CommonApiRpcServer::sign_build_transaction_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
        {
            ...
            dfdcore::wallet::WalletTransactionEntry trasaction_building = parameters["trasaction_building"].as<dfdcore::wallet::WalletTransactionEntry>();
		...
		fc::variant CommonApiRpcServer::contract_register_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::Asset> result = get_client()->contract_register_testing(owner, codefile);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::contract_upgrade_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::Imessage new_contract_desc = parameters[3].as<dfdcore::consensus::Imessage>();
			if (parameters.size() <= 4)
				FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 5 (asset_symbol)");
			std::string asset_symbol = parameters[4].as<std::string>();
			if (parameters.size() <= 5)
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->contract_upgrade(contract_address, upgrader_name, new_contract_name, new_contract_desc, asset_symbol, exec_limit);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::contract_upgrade_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::Imessage new_contract_desc = parameters["new_contract_desc"].as<dfdcore::consensus::Imessage>();
			if (!parameters.contains("asset_symbol"))
				FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'asset_symbol'");
			std::string asset_symbol = parameters["asset_symbol"].as<std::string>();
		...
		fc::variant CommonApiRpcServer::contract_upgrade_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::Asset> result = get_client()->contract_upgrade_testing(contract_address, upgrader_name, new_contract_name, new_contract_desc);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::contract_destroy_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->contract_destroy(contract_address, destroyer_name, asset_symbol, exec_limit);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::contract_destroy_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::Asset> result = get_client()->contract_destroy_testing(contract_address, destroyer_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::contract_call_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->contract_call(contract, caller_name, function_name, params, asset_symbol, call_limit);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::contract_get_info_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::ContractEntryPrintable result = get_client()->contract_get_info(contract);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::contract_get_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::BalanceEntry> result = get_client()->contract_get_balance(contract);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::contract_call_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::Asset> result = get_client()->contract_call_testing(contract, caller_name, function_name, params);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::contract_load_to_file_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::ContractEntryPrintable result = get_client()->contract_load_to_file(contract, file);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::get_result_trx_id_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::TransactionIdType request_id = parameters[0].as<dfdcore::consensus::TransactionIdType>();

			dfdcore::consensus::TransactionIdType result = get_client()->get_result_trx_id(request_id);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::get_result_trx_id_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::TransactionIdType request_id = parameters["request_id"].as<dfdcore::consensus::TransactionIdType>();
		...
		fc::variant CommonApiRpcServer::get_request_trx_id_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::TransactionIdType result = get_client()->get_request_trx_id(request_id);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_contract_call_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->simulator_contract_call(contract, caller_name, function_name, params, cost_asset, callLimit);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_contract_upgrade_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->simulator_contract_upgrade(contract_address, upgrader_name, new_contract_name, new_contract_desc, asset_symbol, exec_limit);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_contract_upgrade_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::Asset> result = get_client()->simulator_contract_upgrade_testing(contract_address, upgrader_name, new_contract_name, new_contract_desc);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_contract_destroy_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->simulator_contract_destroy(contract_address, destroyer_name, asset_symbol, exec_limit);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_contract_destroy_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::Asset> result = get_client()->simulator_contract_destroy_testing(contract_address, destroyer_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_contract_get_info_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::ContractEntryPrintable result = get_client()->simulator_contract_get_info(contract);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_contract_get_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::BalanceEntry> result = get_client()->simulator_contract_get_balance(contract);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_transfer_to_contract_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::WalletTransactionEntry result = get_client()->simulator_transfer_to_contract(amount_to_transfer, asset_symbol, from_account_name, to_contract, amount_for_exec);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_account_balance_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::AccountBalanceSummaryType result = get_client()->simulator_account_balance(account_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_contract_load_to_file_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::ContractEntryPrintable result = get_client()->simulator_contract_load_to_file(contract, file);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_contract_register_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::Asset> result = get_client()->simulator_contract_register_testing(owner, codefile);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_contract_call_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::Asset> result = get_client()->simulator_contract_call_testing(contract, caller_name, function_name, params);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_transfer_to_contract_testing_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::consensus::Asset> result = get_client()->simulator_transfer_to_contract_testing(amount_to_transfer, asset_symbol, from_account_name, to_contract);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::simulator_list_my_addresses_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			vector<dfdcore::consensus::SimulatorAccountInfo> result = get_client()->simulator_list_my_addresses(account_name);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::get_contract_registered_in_transaction_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::TransactionIdType trx_id = parameters[0].as<dfdcore::consensus::TransactionIdType>();
		...
		fc::variant CommonApiRpcServer::get_contract_registered_in_transaction_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			dfdcore::consensus::TransactionIdType trx_id = parameters["trx_id"].as<dfdcore::consensus::TransactionIdType>();
		...
		fc::variant CommonApiRpcServer::get_transaction_id_contract_registered_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::TransactionIdType result = get_client()->get_transaction_id_contract_registered(contract_id);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::contract_get_info_from_gpc_file_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::CodePrintAble result = get_client()->contract_get_info_from_gpc_file(file);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::script_add_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::consensus::Imessage description = parameters[1].as<dfdcore::consensus::Imessage>();
		...
		fc::variant CommonApiRpcServer::script_add_named(fc::rpc::json_connection* json_connection, const fc::variant_object& parameters)
		{
			...
			if (!parameters.contains("description"))
				FC_THROW_EXCEPTION(fc::invalid_arg_exception, "missing required parameter 'description'");
			dfdcore::consensus::Imessage description = parameters["description"].as<dfdcore::consensus::Imessage>();
		...
		fc::variant CommonApiRpcServer::script_get_info_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			dfdcore::wallet::ScriptEntryPrintable result = get_client()->script_get_info(scriptid);
			return fc::variant(result);
		}
		...
		fc::variant CommonApiRpcServer::scripts_list_positional(fc::rpc::json_connection* json_connection, const fc::variants& parameters)
		{
			...
			std::vector<dfdcore::wallet::ScriptEntryPrintable> result = get_client()->scripts_list();
			return fc::variant(result);
		}
		...
		void CommonApiRpcServer::register_common_api_methods(const fc::rpc::json_connection_ptr& json_connection)
		{
           ...
           // register method blockchain_generate_snapshot
			...
			// register method blockchain_get_dfd_account_balance_entry
			bound_positional_method = boost::bind(&CommonApiRpcServer::blockchain_get_dfd_account_balance_entry_positional,
				this, capture_con, _1);
			json_connection->add_method("blockchain_get_dfd_account_balance_entry", bound_positional_method);
            bound_named_method = boost::bind(&CommonApiRpcServer::blockchain_get_dfd_account_balance_entry_named, 
                this, capture_con, _1);
            json_connection->add_named_param_method("blockchain_get_dfd_account_balance_entry", bound_named_method);
        ...
        void CommonApiRpcServer::register_common_api_method_metadata()
        {
            {
                // register method blockchain_get_info
                dfdcore::api::MethodData blockchain_get_info_method_metadata{ "blockchain_get_info", nullptr,
                    /* description */ "Returns current blockchain information and parameters",
                    /* returns */ "json_object",
                    /* params: */{                    },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_generate_snapshot
                dfdcore::api::MethodData blockchain_generate_snapshot_method_metadata{ "blockchain_generate_snapshot", nullptr,
                    /* description */ "Save snapshot of current base asset balances to specified file",
                    /* returns */ "void",
                    /* params: */{
                        {"filename", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_dfd_account_balance_entry
                dfdcore::api::MethodData blockchain_get_dfd_account_balance_entry_method_metadata{ "blockchain_get_dfd_account_balance_entry", nullptr,
                    /* description */ "fetch all DfdTrxidBalance from block where blocknum of the block lower than block_num or equal to block_num.",
                    /* returns */ "vector<dfd_trxid_balance>",
                    /* params: */{
                        {"block_num", "uint32_t", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
                    /* detailed description */ "fetch all DfdTrxidBalance from block where blocknum of the block lower than block_num or equal to block_num.\n\nParameters:\n  block_num (uint32_t, required): \n\nReturns:\n  vector<ub_trxid_balance>\n",
                    /* aliases */ {}, false};
                store_method_metadata(blockchain_get_dfd_account_balance_entry_method_metadata);
            }

            {
                // register method blockchain_generate_issuance_map
                dfdcore::api::MethodData blockchain_generate_issuance_map_method_metadata{ "blockchain_generate_issuance_map", nullptr,
                    /* description */ "A utility to help verify UIA distribution. Returns a snapshot map of all issuances for a particular UIA.",
                    /* returns */ "void",
                    /* params: */{
                        {"symbol", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"filename", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_calculate_supply
                dfdcore::api::MethodData blockchain_calculate_supply_method_metadata{ "blockchain_calculate_supply", nullptr,
                    /* description */ "Calculate the total supply of an asset from the current blockchain database state",
                    /* returns */ "asset",
                    /* params: */{
                        {"asset", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_is_synced
                dfdcore::api::MethodData blockchain_is_synced_method_metadata{ "blockchain_is_synced", nullptr,
            ...
            {
                // register method blockchain_get_block_count
                dfdcore::api::MethodData blockchain_get_block_count_method_metadata{ "blockchain_get_block_count", nullptr,
            ...
            {
                // register method blockchain_get_security_state
                dfdcore::api::MethodData blockchain_get_security_state_method_metadata{ "blockchain_get_security_state", nullptr,
            ...
            {
                // register method blockchain_list_accounts
                dfdcore::api::MethodData blockchain_list_accounts_method_metadata{ "blockchain_list_accounts", nullptr,
                    /* description */ "Returns registered accounts starting with a given name upto a the limit provided",
                    /* returns */ "account_entry_array",
                    /* params: */{
                        {"first_account_name", "account_name", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"limit", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("20"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_recently_updated_accounts
                dfdcore::api::MethodData blockchain_list_recently_updated_accounts_method_metadata{ "blockchain_list_recently_updated_accounts", nullptr,
            ...
            {
                // register method blockchain_list_recently_registered_accounts
                dfdcore::api::MethodData blockchain_list_recently_registered_accounts_method_metadata{ "blockchain_list_recently_registered_accounts", nullptr,
            ...
            {
                // register method blockchain_list_assets
                dfdcore::api::MethodData blockchain_list_assets_method_metadata{ "blockchain_list_assets", nullptr,
                    /* description */ "Returns registered assets starting with a given name upto a the limit provided",
                    /* returns */ "asset_entry_array",
                    /* params: */{
                        {"first_symbol", "asset_symbol", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"limit", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("20"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method wallet_transfer_to_address_build
                dfdcore::api::MethodData wallet_transfer_to_address_build_method_metadata{ "wallet_transfer_to_address_build", nullptr,
                    /* description */ "create a simple (non-TITAN) transfer to an address without signature",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        { "amount_to_transfer", "string", dfdcore::api::required_positional, fc::ovariant() },
                { "asset_symbol", "asset_symbol", dfdcore::api::required_positional, fc::ovariant() },
                { "from_account_public_key", "string", dfdcore::api::required_positional, fc::ovariant() },
                { "to_address", "string", dfdcore::api::required_positional, fc::ovariant() },
                { "memo_message", "information", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\"")) },
                { "strategy", "vote_strategy", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"vote_none\"")) }
                },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_transfer_to_contract_build
                dfdcore::api::MethodData wallet_transfer_to_contract_build_method_metadata{ "wallet_transfer_to_contract_build", nullptr,
                    /* description */ "Do a simple transfer to a contract (name or address)",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        { "amount_to_transfer", "real_amount", dfdcore::api::required_positional, fc::ovariant() },
                { "asset_symbol", "asset_symbol", dfdcore::api::required_positional, fc::ovariant() },
                { "from_account_public_key", "string", dfdcore::api::required_positional, fc::ovariant() },
                { "to_contract", "string", dfdcore::api::required_positional, fc::ovariant() },
                { "amount_for_exec", "real_amount", dfdcore::api::required_positional, fc::ovariant() }
                },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_call_contract_build
                dfdcore::api::MethodData wallet_call_contract_build_method_metadata{ "wallet_call_contract_build", nullptr,
                    /* description */ "call contract by contract name or contract address without signature",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        { "contract", "string", dfdcore::api::required_positional, fc::ovariant() },
                { "caller_publickey", "string", dfdcore::api::required_positional, fc::ovariant() },
                { "function_name", "string", dfdcore::api::required_positional, fc::ovariant() },
                { "params", "string", dfdcore::api::required_positional, fc::ovariant() },
                { "asset_symbol", "string", dfdcore::api::required_positional, fc::ovariant() },
                { "call_limit", "optional_double", dfdcore::api::required_positional, fc::ovariant() }
                },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method sign_build_transaction
                dfdcore::api::MethodData sign_build_transaction_method_metadata{ "sign_build_transaction", nullptr,
                    /* description */ "sign transaction which get from build interface",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        { "trasaction_building", "transaction_entry", dfdcore::api::required_positional, fc::ovariant() }
                },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method broadcast_building_transaction
                dfdcore::api::MethodData broadcast_building_transaction_method_metadata{ "broadcast_building_transaction", nullptr,
            ...
            {
                // register method blockchain_list_pending_transactions
                dfdcore::api::MethodData blockchain_list_pending_transactions_method_metadata{ "blockchain_list_pending_transactions", nullptr,
            ...
            {
                // register method blockchain_get_transaction
                dfdcore::api::MethodData blockchain_get_transaction_method_metadata{ "blockchain_get_transaction", nullptr,
                    /* description */ "Get detailed information about an in-wallet transaction",
                    /* returns */ "transaction_entry_pair",
                    /* params: */{
                        {"transaction_id_prefix", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"exact", "bool", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("false"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_pretty_transaction
                dfdcore::api::MethodData blockchain_get_pretty_transaction_method_metadata{ "blockchain_get_pretty_transaction", nullptr,
            ...
            {
                // register method blockchain_get_pretty_contract_transaction
                dfdcore::api::MethodData blockchain_get_pretty_contract_transaction_method_metadata{ "blockchain_get_pretty_contract_transaction", nullptr,
            ...
            {
                // register method blockchain_get_block
                dfdcore::api::MethodData blockchain_get_block_method_metadata{ "blockchain_get_block", nullptr,
                    /* description */ "Retrieves the block entry for the given block number or ID",
                    /* returns */ "oblock_entry",
                    /* params: */{
                        {"block", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_block_transactions
                dfdcore::api::MethodData blockchain_get_block_transactions_method_metadata{ "blockchain_get_block_transactions", nullptr,
            ...
            {
                // register method blockchain_get_account
                dfdcore::api::MethodData blockchain_get_account_method_metadata{ "blockchain_get_account", nullptr,
                    /* description */ "Retrieves the entry for the given account name or ID",
                    /* returns */ "optional_account_entry",
                    /* params: */{
                        {"account", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_slate
                dfdcore::api::MethodData blockchain_get_slate_method_metadata{ "blockchain_get_slate", nullptr,
                    ...
                    /* params: */{
                        {"slate", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_balance
                dfdcore::api::MethodData blockchain_get_balance_method_metadata{ "blockchain_get_balance", nullptr,
                    /* description */ "Retrieves the specified balance entry",
                    /* returns */ "balance_entry",
                    /* params: */{
                        {"balance_id", "address", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_balances
                dfdcore::api::MethodData blockchain_list_balances_method_metadata{ "blockchain_list_balances", nullptr,
                    /* description */ "Lists balance entrys starting at the given balance ID",
                    /* returns */ "balance_entry_map",
                    /* params: */{
                        {"first_balance_id", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"limit", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("20"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_address_balances
                dfdcore::api::MethodData blockchain_list_address_balances_method_metadata{ "blockchain_list_address_balances", nullptr,
                    /* description */ "Lists balance entrys which are the balance IDs or which can be claimed by signature for this address",
                    /* returns */ "balance_entry_map",
                    /* params: */{
                        {"addr", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"chanced_since", "timestamp", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"1970-1-1T00:00:01\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_address_transactions
                dfdcore::api::MethodData blockchain_list_address_transactions_method_metadata{ "blockchain_list_address_transactions", nullptr,
                    /* description */ "Lists all transactions that involve the provided address after the specified time",
                    /* returns */ "variant_object",
                    /* params: */{
                        {"addr", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"filter_before", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"0\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_account_public_balance
                dfdcore::api::MethodData blockchain_get_account_public_balance_method_metadata{ "blockchain_get_account_public_balance", nullptr,
                    /* description */ "Get the account entry for a given name",
                    /* returns */ "account_balance_summary_type",
                    /* params: */{
                        {"account_name", "account_name", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method blockchain_list_key_balances
                dfdcore::api::MethodData blockchain_list_key_balances_method_metadata{ "blockchain_list_key_balances", nullptr,
                    /* description */ "Lists balance entrys which can be claimed by signature for this key",
                    /* returns */ "balance_entry_map",
                    /* params: */{
                        {"key", "public_key", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_asset
                dfdcore::api::MethodData blockchain_get_asset_method_metadata{ "blockchain_get_asset", nullptr,
            ...
            {
                // register method blockchain_list_active_delegates
                dfdcore::api::MethodData blockchain_list_active_delegates_method_metadata{ "blockchain_list_active_delegates", nullptr,
                    /* description */ "Returns a list of the current round's active delegates in signing order",
                    /* returns */ "account_entry_array",
                    /* params: */{
                        {"first", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("0"))},
                        {"count", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("20"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_delegates
                dfdcore::api::MethodData blockchain_list_delegates_method_metadata{ "blockchain_list_delegates", nullptr,
            ...
            {
                // register method blockchain_list_blocks
                dfdcore::api::MethodData blockchain_list_blocks_method_metadata{ "blockchain_list_blocks", nullptr,
                    /* description */ "Returns a descending list of block entrys starting from the specified block number",
                    /* returns */ "block_entry_array",
                    /* params: */{
                        {"max_block_num", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("-1"))},
                        {"limit", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("20"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_missing_block_delegates
                dfdcore::api::MethodData blockchain_list_missing_block_delegates_method_metadata{ "blockchain_list_missing_block_delegates", nullptr,
                    /* description */ "Returns any delegates who were supposed to produce a given block number but didn't",
                    /* returns */ "account_name_array",
                    /* params: */{
                        {"block_number", "uint32_t", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_export_fork_graph
                dfdcore::api::MethodData blockchain_export_fork_graph_method_metadata{ "blockchain_export_fork_graph", nullptr,
                    /* description */ "dumps the fork data to graphviz format",
                    /* returns */ "string",
                    /* params: */{
                        {"start_block", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("1"))},
                        {"end_block", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("-1"))},
                        {"filename", "path", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_forks
                dfdcore::api::MethodData blockchain_list_forks_method_metadata{ "blockchain_list_forks", nullptr,
            ...
            {
                // register method blockchain_get_delegate_slot_entrys
                dfdcore::api::MethodData blockchain_get_delegate_slot_entrys_method_metadata{ "blockchain_get_delegate_slot_entrys", nullptr,
                    /* description */ "Query the most recent block production slot entrys for the specified delegate",
                    /* returns */ "slot_entrys_list",
                    /* params: */{
                        {"delegate_name", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"limit", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"10\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_block_signee
                dfdcore::api::MethodData blockchain_get_block_signee_method_metadata{ "blockchain_get_block_signee", nullptr,
            ...
            {
                // register method blockchain_unclaimed_genesis
                dfdcore::api::MethodData blockchain_unclaimed_genesis_method_metadata{ "blockchain_unclaimed_genesis", nullptr,
            ...
            {
                // register method blockchain_verify_signature
                dfdcore::api::MethodData blockchain_verify_signature_method_metadata{ "blockchain_verify_signature", nullptr,
                    /* description */ "Verify that the given signature proves the given hash was signed by the given account.",
                    /* returns */ "bool",
                    /* params: */{
                        {"signer", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"hash", "sha256", dfdcore::api::required_positional, fc::ovariant()},
                        {"signature", "compact_signature", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_dump_state
                dfdcore::api::MethodData blockchain_dump_state_method_metadata{ "blockchain_dump_state", nullptr,
                    /* description */ "TODO",
                    /* returns */ "void",
                    /* params: */{
                        {"path", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_broadcast_transaction
                dfdcore::api::MethodData blockchain_broadcast_transaction_method_metadata{ "blockchain_broadcast_transaction", nullptr,
                    /* description */ "Takes a signed transaction and broadcasts it to the network.",
                    /* returns */ "void",
                    /* params: */{
                        {"trx", "signed_transaction", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_btc_address_convert
                dfdcore::api::MethodData blockchain_btc_address_convert_method_metadata{ "blockchain_btc_address_convert", nullptr,
                    /* description */ "Convert bitcoin address file to dfdcore address file.",
                    /* returns */ "void",
                    /* params: */{
                        {"path", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
                    /* detailed description */ "Convert bitcoin address file to dfdcore address file.\n\nParameters:\n  path (string, required): The bitcoin address file path.\n\nReturns:\n  void\n",
                    /* aliases */ {}, true};
            ...
            {
                // register method blockchain_get_transaction_rpc
                dfdcore::api::MethodData blockchain_get_transaction_rpc_method_metadata{ "blockchain_get_transaction_rpc", nullptr,
                    /* description */ "Get detailed information about an in-wallet transaction",
                    /* returns */ "string",
                    /* params: */{
                        {"transaction_id_prefix", "string", dfdcore::api::required_positional, fc::ovariant()},
            ...
            {
                // register method blockchain_set_node_vm_enabled
                dfdcore::api::MethodData blockchain_set_node_vm_enabled_method_metadata{ "blockchain_set_node_vm_enabled", nullptr,
                    /* description */ "set the vm enabled flag of normal node, no effect for the delegate",
                    /* returns */ "void",
                    /* params: */{
                        {"enabled", "bool", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_get_node_vm_enabled
                dfdcore::api::MethodData blockchain_get_node_vm_enabled_method_metadata{ "blockchain_get_node_vm_enabled", nullptr,
            ...
            {
                // register method blockchain_get_all_contracts
                dfdcore::api::MethodData blockchain_get_all_contracts_method_metadata{ "blockchain_get_all_contracts", nullptr,
            ...
            {
                // register method blockchain_get_forever_contracts
                dfdcore::api::MethodData blockchain_get_forever_contracts_method_metadata{ "blockchain_get_forever_contracts", nullptr,
            ...
            {
                // register method blockchain_list_pub_all_address
                dfdcore::api::MethodData blockchain_list_pub_all_address_method_metadata{ "blockchain_list_pub_all_address", nullptr,
                    /* description */ "list all address converted by public",
                    /* returns */ "string_array",
                    /* params: */{
                        {"pub_key", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method blockchain_list_contract_transaction_history
                dfdcore::api::MethodData blockchain_list_contract_transaction_history_method_metadata{ "blockchain_list_contract_transaction_history", nullptr,
                    /* description */ "Lists contract transactions match the conditions",
                    /* returns */ "contract_transaction_summarys",
                    /* params: */{
                        {"from_block_num", "uint32_t", dfdcore::api::required_positional, fc::ovariant()},
                        {"block_count", "uint32_t", dfdcore::api::required_positional, fc::ovariant()},
                        {"contract_id", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"trx_type", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"99\""))},
                        {"call_method", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method network_add_node
                dfdcore::api::MethodData network_add_node_method_metadata{ "network_add_node", nullptr,
                    /* description */ "Attempts add or remove <node> from the peer list or try a connection to <node> once",
                    /* returns */ "void",
                    /* params: */{
                        {"node", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"command", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"add\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method network_get_connection_count
                dfdcore::api::MethodData network_get_connection_count_method_metadata{ "network_get_connection_count", nullptr,
            ...
            {
                // register method network_get_peer_info
                dfdcore::api::MethodData network_get_peer_info_method_metadata{ "network_get_peer_info", nullptr,
                    /* description */ "Returns data about each connected node",
                    /* returns */ "json_object_array",
                    /* params: */{
                        {"not_firewalled", "bool", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("false"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method network_broadcast_transaction
                dfdcore::api::MethodData network_broadcast_transaction_method_metadata{ "network_broadcast_transaction", nullptr,
                    /* description */ "Broadcast a previously-created signed transaction to the network",
                    /* returns */ "transaction_id",
                    /* params: */{
                        {"transaction_to_broadcast", "signed_transaction", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 9,
            ...
            {
                // register method network_set_advanced_node_parameters
                dfdcore::api::MethodData network_set_advanced_node_parameters_method_metadata{ "network_set_advanced_node_parameters", nullptr,
                    /* description */ "Sets advanced node parameters, used for setting up automated tests",
                    /* returns */ "void",
                    /* params: */{
                        {"params", "json_object", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method network_get_advanced_node_parameters
                dfdcore::api::MethodData network_get_advanced_node_parameters_method_metadata{ "network_get_advanced_node_parameters", nullptr,
                    /* description */ "Sets advanced node parameters, used for setting up automated tests",
                    /* returns */ "json_object",
                    /* params: */{                    },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method network_get_transaction_propagation_data
                dfdcore::api::MethodData network_get_transaction_propagation_data_method_metadata{ "network_get_transaction_propagation_data", nullptr,
                    /* description */ "Returns the time the transaction was first seen by this client",
                    /* returns */ "message_propagation_data",
                    /* params: */{
                        {"transaction_id", "transaction_id", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method network_get_block_propagation_data
                dfdcore::api::MethodData network_get_block_propagation_data_method_metadata{ "network_get_block_propagation_data", nullptr,
                    /* description */ "Returns the time the block was first seen by this client",
                    /* returns */ "message_propagation_data",
                    /* params: */{
                        {"block_hash", "block_id_type", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method network_get_info
                dfdcore::api::MethodData network_get_info_method_metadata{ "network_get_info", nullptr,
            ...
            {
                // register method network_list_potential_peers
                dfdcore::api::MethodData network_list_potential_peers_method_metadata{ "network_list_potential_peers", nullptr,
            ...
            {
                // register method network_get_upnp_info
                dfdcore::api::MethodData network_get_upnp_info_method_metadata{ "network_get_upnp_info", nullptr,
            ...
            {
                // register method network_get_blocked_ips
                dfdcore::api::MethodData network_get_blocked_ips_method_metadata{ "network_get_blocked_ips", nullptr,
            ...
            {
                // register method debug_get_client_name
                dfdcore::api::MethodData debug_get_client_name_method_metadata{ "debug_get_client_name", nullptr,
            ...
            {
                // register method delegate_get_config
                dfdcore::api::MethodData delegate_get_config_method_metadata{ "delegate_get_config", nullptr,
            ...
            {
                // register method delegate_set_network_min_connection_count
                dfdcore::api::MethodData delegate_set_network_min_connection_count_method_metadata{ "delegate_set_network_min_connection_count", nullptr,
                    /* description */ "Set minimum network connection count required for block production",
                    /* returns */ "void",
                    /* params: */{
                        {"count", "uint32_t", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_set_block_max_transaction_count
                dfdcore::api::MethodData delegate_set_block_max_transaction_count_method_metadata{ "delegate_set_block_max_transaction_count", nullptr,
            ...
            {
                // register method delegate_set_soft_max_imessage_length
                dfdcore::api::MethodData delegate_set_soft_max_imessage_length_method_metadata{ "delegate_set_soft_max_imessage_length", nullptr,
                    /* description */ "Set soft max length",
                    /* returns */ "void",
                    /* params: */{
                        {"soft_length", "int64_t", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_set_imessage_fee_coe
                dfdcore::api::MethodData delegate_set_imessage_fee_coe_method_metadata{ "delegate_set_imessage_fee_coe", nullptr,
                    /* description */ "Set fee coe",
                    /* returns */ "void",
                    /* params: */{
                        {"fee_coe", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_set_block_max_size
                dfdcore::api::MethodData delegate_set_block_max_size_method_metadata{ "delegate_set_block_max_size", nullptr,
                    /* description */ "Set maximum block size allowed",
                    /* returns */ "void",
                    /* params: */{
                        {"size", "uint32_t", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_set_transaction_max_size
                dfdcore::api::MethodData delegate_set_transaction_max_size_method_metadata{ "delegate_set_transaction_max_size", nullptr,
            ...
            {
                // register method delegate_set_transaction_canonical_signatures_required
                dfdcore::api::MethodData delegate_set_transaction_canonical_signatures_required_method_metadata{ "delegate_set_transaction_canonical_signatures_required", nullptr,
                    /* description */ "Set whether canonical signatures are required",
                    /* returns */ "void",
                    /* params: */{
                        {"required", "bool", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_set_transaction_min_fee
                dfdcore::api::MethodData delegate_set_transaction_min_fee_method_metadata{ "delegate_set_transaction_min_fee", nullptr,
                    /* description */ "Set minimum transaction fee allowed",
                    /* returns */ "void",
                    /* params: */{
                        {"fee", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_blacklist_add_transaction
                dfdcore::api::MethodData delegate_blacklist_add_transaction_method_metadata{ "delegate_blacklist_add_transaction", nullptr,
                    /* description */ "Add specified transaction to blacklist",
                    /* returns */ "void",
                    /* params: */{
                        {"id", "transaction_id", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_blacklist_remove_transaction
                dfdcore::api::MethodData delegate_blacklist_remove_transaction_method_metadata{ "delegate_blacklist_remove_transaction", nullptr,
            ...
            {
                // register method delegate_blacklist_add_operation
                dfdcore::api::MethodData delegate_blacklist_add_operation_method_metadata{ "delegate_blacklist_add_operation", nullptr,
                    /* description */ "Add specified operation to blacklist",
                    /* returns */ "void",
                    /* params: */{
                        {"id", "operation_type", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method delegate_blacklist_remove_operation
                dfdcore::api::MethodData delegate_blacklist_remove_operation_method_metadata{ "delegate_blacklist_remove_operation", nullptr,
            ...
            {
                // register method wallet_get_info
                dfdcore::api::MethodData wallet_get_info_method_metadata{ "wallet_get_info", nullptr,
            ...
            {
                // register method wallet_open
                dfdcore::api::MethodData wallet_open_method_metadata{ "wallet_open", nullptr,
                    /* description */ "Opens the wallet of the given name",
                    /* returns */ "void",
                    /* params: */{
                        {"wallet_name", "wallet_name", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method wallet_create
                dfdcore::api::MethodData wallet_create_method_metadata{ "wallet_create", nullptr,
                    /* description */ "Creates a wallet with the given name",
                    /* returns */ "void",
                    /* params: */{
                        {"wallet_name", "wallet_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"new_passphrase", "new_passphrase", dfdcore::api::required_positional, fc::ovariant()},
                        {"brain_key", "brainkey", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method wallet_get_name
                dfdcore::api::MethodData wallet_get_name_method_metadata{ "wallet_get_name", nullptr,
            ...
            {
                // register method wallet_import_private_key
                dfdcore::api::MethodData wallet_import_private_key_method_metadata{ "wallet_import_private_key", nullptr,
                    ...
                    /* params: */{
                        {"wif_key", "wif_private_key", dfdcore::api::required_positional, fc::ovariant()},
                        {"account_name", "account_name", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("null"))},
                        {"create_new_account", "bool", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("false"))},
                        {"rescan", "bool", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("false"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_close
                dfdcore::api::MethodData wallet_close_method_metadata{ "wallet_close", nullptr,
            ...
            {
                // register method wallet_backup_create
                dfdcore::api::MethodData wallet_backup_create_method_metadata{ "wallet_backup_create", nullptr,
                    /* description */ "Exports the current wallet to a JSON file",
                    /* returns */ "void",
                    /* params: */{
                        {"json_filename", "filename", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_backup_restore
                dfdcore::api::MethodData wallet_backup_restore_method_metadata{ "wallet_backup_restore", nullptr,
                    /* description */ "Creates a new wallet from an exported JSON file",
                    /* returns */ "void",
                    /* params: */{
                        {"json_filename", "filename", dfdcore::api::required_positional, fc::ovariant()},
                        {"wallet_name", "wallet_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"imported_wallet_passphrase", "passphrase", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method wallet_set_automatic_backups
                dfdcore::api::MethodData wallet_set_automatic_backups_method_metadata{ "wallet_set_automatic_backups", nullptr,
            ...
            {
                // register method wallet_set_transaction_expiration_time
                dfdcore::api::MethodData wallet_set_transaction_expiration_time_method_metadata{ "wallet_set_transaction_expiration_time", nullptr,
                    /* description */ "Set transaction expiration time",
                    /* returns */ "uint32_t",
                    /* params: */{
                        {"seconds", "uint32_t", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_account_transaction_history
                dfdcore::api::MethodData wallet_account_transaction_history_method_metadata{ "wallet_account_transaction_history", nullptr,
                    /* description */ "Lists transaction history for the specified account",
                    /* returns */ "pretty_transactions",
                    /* params: */{
                        {"account_name", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"asset_symbol", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"limit", "int32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("0"))},
                        {"start_block_num", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("0"))},
                        {"end_block_num", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("-1"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_transaction_history_splite
                dfdcore::api::MethodData wallet_transaction_history_splite_method_metadata{ "wallet_transaction_history_splite", nullptr,
                    /* description */ "Lists transaction history for the specified account",
                    /* returns */ "pretty_transactions",
                    /* params: */{
                        {"account_name", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"asset_symbol", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"limit", "int32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("0"))},
                        {"transaction_type", "int32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"2\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_account_historic_balance
                dfdcore::api::MethodData wallet_account_historic_balance_method_metadata{ "wallet_account_historic_balance", nullptr,
                    /* description */ "Lists wallet's balance at the given time",
                    /* returns */ "account_balance_summary_type",
                    /* params: */{
                        {"time", "timestamp", dfdcore::api::required_positional, fc::ovariant()},
                        {"account_name", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_remove_transaction
                dfdcore::api::MethodData wallet_remove_transaction_method_metadata{ "wallet_remove_transaction", nullptr,
                    ...
                    /* returns */ "void",
                    /* params: */{
                        {"transaction_id", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_get_pending_transaction_errors
                dfdcore::api::MethodData wallet_get_pending_transaction_errors_method_metadata{ "wallet_get_pending_transaction_errors", nullptr,
            ...
            {
                // register method wallet_lock
                dfdcore::api::MethodData wallet_lock_method_metadata{ "wallet_lock", nullptr,
            ...
            {
                // register method wallet_unlock
                dfdcore::api::MethodData wallet_unlock_method_metadata{ "wallet_unlock", nullptr,
                    /* description */ "Unlock the private keys in the wallet to enable spending operations",
                    /* returns */ "void",
                    /* params: */{
                        {"timeout", "uint32_t", dfdcore::api::required_positional, fc::ovariant()},
                        {"passphrase", "passphrase", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_change_passphrase
                dfdcore::api::MethodData wallet_change_passphrase_method_metadata{ "wallet_change_passphrase", nullptr,
                    /* description */ "Change the password of the current wallet",
                    /* returns */ "void",
                    /* params: */{
                        {"old_passphrase", "passphrase", dfdcore::api::required_positional, fc::ovariant()},
                        {"passphrase", "passphrase", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_check_passphrase
                dfdcore::api::MethodData wallet_check_passphrase_method_metadata{ "wallet_check_passphrase", nullptr,
            ...
            {
                // register method wallet_check_address
                dfdcore::api::MethodData wallet_check_address_method_metadata{ "wallet_check_address", nullptr,
                    /* description */ "check address is valid address or an acount name.",
                    /* returns */ "bool",
                    /* params: */{
                        {"address", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_list
                dfdcore::api::MethodData wallet_list_method_metadata{ "wallet_list", nullptr,
            ...
            {
                // register method wallet_account_create
                dfdcore::api::MethodData wallet_account_create_method_metadata{ "wallet_account_create", nullptr,
                    /* description */ "Add new account for receiving payments",
                    /* returns */ "address",
                    /* params: */{
                        {"account_name", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"private_data", "json_variant", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("null"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_account_set_approval
                dfdcore::api::MethodData wallet_account_set_approval_method_metadata{ "wallet_account_set_approval", nullptr,
                    /* description */ "Updates your approval of the specified account",
                    /* returns */ "int8_t",
                    /* params: */{
                        {"account_name", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"approval", "int8_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("1"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_get_all_approved_accounts
                dfdcore::api::MethodData wallet_get_all_approved_accounts_method_metadata{ "wallet_get_all_approved_accounts", nullptr,
            ...
            {
                // register method wallet_address_create
                dfdcore::api::MethodData wallet_address_create_method_metadata{ "wallet_address_create", nullptr,
                    /* description */ "Creates an address which can be used for a simple (non-TITAN) transfer.",
                    /* returns */ "string",
                    /* params: */{
                        {"account_name", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"label", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"legacy_network_byte", "int32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("-1"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_transfer_to_address
                dfdcore::api::MethodData wallet_transfer_to_address_method_metadata{ "wallet_transfer_to_address", nullptr,
                    /* description */ "Do a simple (non-TITAN) transfer to an address",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"amount_to_transfer", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "asset_symbol", dfdcore::api::required_positional, fc::ovariant()},
                        {"from_account_name", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"to_address", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"memo_message", "information", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"strategy", "vote_strategy", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"vote_recommended\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_transfer_to_public_account
                dfdcore::api::MethodData wallet_transfer_to_public_account_method_metadata{ "wallet_transfer_to_public_account", nullptr,
                    /* description */ "Sends given amount to the given account",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"amount_to_transfer", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "asset_symbol", dfdcore::api::required_positional, fc::ovariant()},
                        {"from_account_name", "sending_account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"to_account_name", "receive_account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"memo_message", "information", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"strategy", "vote_strategy", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"vote_recommended\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_withdraw_from_address
                dfdcore::api::MethodData wallet_withdraw_from_address_method_metadata{ "wallet_withdraw_from_address", nullptr,
                    /* description */ "",
                    /* returns */ "transaction_builder",
                    /* params: */{
                        {"amount", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"symbol", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"from_address", "address", dfdcore::api::required_positional, fc::ovariant()},
                        {"to", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"strategy", "vote_strategy", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"vote_none\""))},
                        {"sign_and_broadcast", "bool", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("true"))},
                        {"builder_path", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method wallet_rescan_blockchain
                dfdcore::api::MethodData wallet_rescan_blockchain_method_metadata{ "wallet_rescan_blockchain", nullptr,
                    /* description */ "Scans the blockchain history for operations relevant to this wallet.",
                    /* returns */ "void",
                    /* params: */{
                        {"start_block_num", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("0"))},
                        {"limit", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("-1"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_cancel_scan
                dfdcore::api::MethodData wallet_cancel_scan_method_metadata{ "wallet_cancel_scan", nullptr,
            ...
            {
                // register method wallet_get_transaction
                dfdcore::api::MethodData wallet_get_transaction_method_metadata{ "wallet_get_transaction", nullptr,
            ...
            {
                // register method wallet_scan_transaction
                dfdcore::api::MethodData wallet_scan_transaction_method_metadata{ "wallet_scan_transaction", nullptr,
                    /* description */ "Scans the specified transaction",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"transaction_id", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"overwrite_existing", "bool", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("false"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_rebroadcast_transaction
                dfdcore::api::MethodData wallet_rebroadcast_transaction_method_metadata{ "wallet_rebroadcast_transaction", nullptr,
            ...
            {
                // register method wallet_account_register
                dfdcore::api::MethodData wallet_account_register_method_metadata{ "wallet_account_register", nullptr,
                    /* description */ "Updates the data published about a given account",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"account_name", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"pay_from_account", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"public_data", "json_variant", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("null"))},
                        {"delegate_pay_rate", "uint8_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("-1"))},
                        {"account_type", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"titan_account\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_account_update_private_data
                dfdcore::api::MethodData wallet_account_update_private_data_method_metadata{ "wallet_account_update_private_data", nullptr,
            ...
            {
                // register method wallet_account_update_registration
                dfdcore::api::MethodData wallet_account_update_registration_method_metadata{ "wallet_account_update_registration", nullptr,
                    /* description */ "Updates the data published about a given account",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"account_name", "account_name", dfdcore::api::required_positional, fc::ovariant()},
            ...
            {
                // register method wallet_account_update_active_key
                dfdcore::api::MethodData wallet_account_update_active_key_method_metadata{ "wallet_account_update_active_key", nullptr,
                    /* description */ "Updates the specified account's active key and broadcasts the transaction.",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"account_to_update", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"pay_from_account", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"new_active_key", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_list_accounts
                dfdcore::api::MethodData wallet_list_accounts_method_metadata{ "wallet_list_accounts", nullptr,
            ...
            {
                // register method wallet_list_unregistered_accounts
                dfdcore::api::MethodData wallet_list_unregistered_accounts_method_metadata{ "wallet_list_unregistered_accounts", nullptr,
            ...
            {
                // register method wallet_list_my_accounts
                dfdcore::api::MethodData wallet_list_my_accounts_method_metadata{ "wallet_list_my_accounts", nullptr,
            ...
            {
                // register method wallet_list_my_addresses
                dfdcore::api::MethodData wallet_list_my_addresses_method_metadata{ "wallet_list_my_addresses", nullptr,
            ...
            {
                // register method wallet_get_account
                dfdcore::api::MethodData wallet_get_account_method_metadata{ "wallet_get_account", nullptr,
                    /* description */ "Get the account entry for a given name",
            ...
            {
                // register method wallet_get_account_public_address
                dfdcore::api::MethodData wallet_get_account_public_address_method_metadata{ "wallet_get_account_public_address", nullptr,
                    /* description */ "Get the account entry for a given name",
                    /* returns */ "string",
                    /* params: */{
                        {"account_name", "account_name", dfdcore::api::required_positional, fc::ovariant()}
            ...
            {
                // register method wallet_remove_contact_account
                dfdcore::api::MethodData wallet_remove_contact_account_method_metadata{ "wallet_remove_contact_account", nullptr,
            ...
            {
                // register method wallet_account_rename
                dfdcore::api::MethodData wallet_account_rename_method_metadata{ "wallet_account_rename", nullptr,
                    /* description */ "Rename an account in wallet",
                    /* returns */ "void",
                    /* params: */{
                        {"current_account_name", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"new_account_name", "new_account_name", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_asset_create
                dfdcore::api::MethodData wallet_asset_create_method_metadata{ "wallet_asset_create", nullptr,
                    /* description */ "Creates a new user issued asset",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"symbol", "asset_symbol", dfdcore::api::required_positional, fc::ovariant()},
                        {"asset_name", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"issuer_name", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"description", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"maximum_share_supply", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"precision", "uint64_t", dfdcore::api::required_positional, fc::ovariant()},
                        {"public_data", "json_variant", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("null"))},
                        {"is_market_issued", "bool", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("false"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_asset_issue
                dfdcore::api::MethodData wallet_asset_issue_method_metadata{ "wallet_asset_issue", nullptr,
                    /* description */ "Issues new shares of a given asset type",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"amount", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"symbol", "asset_symbol", dfdcore::api::required_positional, fc::ovariant()},
                        {"to_account_name", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"memo_message", "information", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_asset_issue_to_addresses
                dfdcore::api::MethodData wallet_asset_issue_to_addresses_method_metadata{ "wallet_asset_issue_to_addresses", nullptr,
                    /* description */ "Issues new UIA shares to specific addresses.",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"symbol", "asset_symbol", dfdcore::api::required_positional, fc::ovariant()},
                        {"addresses", "snapshot_map", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_account_balance
                dfdcore::api::MethodData wallet_account_balance_method_metadata{ "wallet_account_balance", nullptr,
                    /* description */ "Lists the total asset balances for the specified account",
                    /* returns */ "account_balance_summary_type",
                    /* params: */{
                        {"account_name", "account_name", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_account_balance_ids
                dfdcore::api::MethodData wallet_account_balance_ids_method_metadata{ "wallet_account_balance_ids", nullptr,
            ...
            {
                // register method wallet_account_list_public_keys
                dfdcore::api::MethodData wallet_account_list_public_keys_method_metadata{ "wallet_account_list_public_keys", nullptr,
            ...
            {
                // register method wallet_delegate_withdraw_pay
                dfdcore::api::MethodData wallet_delegate_withdraw_pay_method_metadata{ "wallet_delegate_withdraw_pay", nullptr,
                    /* description */ "Used to transfer some of the delegate's pay from their balance",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"delegate_name", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"to_account_name", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"amount_to_withdraw", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_delegate_pay_balance_query
                dfdcore::api::MethodData wallet_delegate_pay_balance_query_method_metadata{ "wallet_delegate_pay_balance_query", nullptr,
            ...
            {
                // register method wallet_active_delegate_salary
                dfdcore::api::MethodData wallet_active_delegate_salary_method_metadata{ "wallet_active_delegate_salary", nullptr,
                    /* description */ "query delegate's pay balance",
            ...
            {
                // register method wallet_get_delegate_statue
                dfdcore::api::MethodData wallet_get_delegate_statue_method_metadata{ "wallet_get_delegate_statue", nullptr,
            ...
            {
                // register method wallet_set_transaction_imessage_fee_coe
                dfdcore::api::MethodData wallet_set_transaction_imessage_fee_coe_method_metadata{ "wallet_set_transaction_imessage_fee_coe", nullptr,
            ...
            {
                // register method wallet_get_transaction_imessage_fee_coe
                dfdcore::api::MethodData wallet_get_transaction_imessage_fee_coe_method_metadata{ "wallet_get_transaction_imessage_fee_coe", nullptr,
            ...
            {
                // register method wallet_set_transaction_imessage_soft_max_length
                dfdcore::api::MethodData wallet_set_transaction_imessage_soft_max_length_method_metadata{ "wallet_set_transaction_imessage_soft_max_length", nullptr,
                    /* description */ "Set imessage soft max length",
                    /* returns */ "void",
                    /* params: */{
                        {"soft_length", "amount", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_get_transaction_imessage_soft_max_length
                dfdcore::api::MethodData wallet_get_transaction_imessage_soft_max_length_method_metadata{ "wallet_get_transaction_imessage_soft_max_length", nullptr,
            ...
            {
                // register method wallet_set_transaction_fee
                dfdcore::api::MethodData wallet_set_transaction_fee_method_metadata{ "wallet_set_transaction_fee", nullptr,
            ...
            {
                // register method wallet_get_transaction_fee
                dfdcore::api::MethodData wallet_get_transaction_fee_method_metadata{ "wallet_get_transaction_fee", nullptr,
                    /* description */ "Returns ",
                    /* returns */ "asset",
                    /* params: */{
                        {"symbol", "asset_symbol", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_dump_private_key
                dfdcore::api::MethodData wallet_dump_private_key_method_metadata{ "wallet_dump_private_key", nullptr,
                    ...
                    /* params: */{
                        {"input", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_dump_account_private_key
                dfdcore::api::MethodData wallet_dump_account_private_key_method_metadata{ "wallet_dump_account_private_key", nullptr,
                    /* description */ "Reveals the specified account private key; use with caution",
                    /* returns */ "optional_string",
                    /* params: */{
                        {"account_name", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"key_type", "account_key_type", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_account_vote_summary
                dfdcore::api::MethodData wallet_account_vote_summary_method_metadata{ "wallet_account_vote_summary", nullptr,
            ...
            {
                // register method wallet_check_vote_status
                dfdcore::api::MethodData wallet_check_vote_status_method_metadata{ "wallet_check_vote_status", nullptr,
                    /* description */ "Get info about the votes of balances controlled by this account",
                    /* returns */ "vote_summary",
                    /* params: */{
                        {"account", "account_name", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_set_setting
                dfdcore::api::MethodData wallet_set_setting_method_metadata{ "wallet_set_setting", nullptr,
                    /* description */ "Set a property in the GUI settings DB",
                    /* returns */ "void",
                    /* params: */{
                        {"name", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"value", "variant", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_get_setting
                dfdcore::api::MethodData wallet_get_setting_method_metadata{ "wallet_get_setting", nullptr,
            ...
            {
                // register method wallet_delegate_set_block_production
                dfdcore::api::MethodData wallet_delegate_set_block_production_method_metadata{ "wallet_delegate_set_block_production", nullptr,
            ...
            {
                // register method wallet_set_transaction_scanning
                dfdcore::api::MethodData wallet_set_transaction_scanning_method_metadata{ "wallet_set_transaction_scanning", nullptr,
            ...
            {
                // register method wallet_sign_hash
                dfdcore::api::MethodData wallet_sign_hash_method_metadata{ "wallet_sign_hash", nullptr,
            ...
            {
                // register method wallet_login_start
                dfdcore::api::MethodData wallet_login_start_method_metadata{ "wallet_login_start", nullptr,
                    /* description */ "Initiates the login procedure by providing a Dfd Login URL",
                    /* returns */ "string",
                    /* params: */{
                        {"server_account", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
                    /* detailed description */ "Initiates the login procedure by providing a Dfd Login URL\n\nParameters:\n  server_account (string, required): Name of the account of the server. The user will be shown this name as the site he is logging into.\n\nReturns:\n  string\n",
                    /* aliases */ {}, false};
            ...
            {
                // register method wallet_login_finish
                dfdcore::api::MethodData wallet_login_finish_method_metadata{ "wallet_login_finish", nullptr,
                    /* description */ "Completes the login procedure by finding the user's public account key and shared secret",
                    /* returns */ "variant",
                    /* params: */{
                        {"server_key", "public_key", dfdcore::api::required_positional, fc::ovariant()},
                        {"client_key", "public_key", dfdcore::api::required_positional, fc::ovariant()},
                        {"client_signature", "compact_signature", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_balance_set_vote_info
                dfdcore::api::MethodData wallet_balance_set_vote_info_method_metadata{ "wallet_balance_set_vote_info", nullptr,
                    /* description */ "Set this balance's voting address and slate",
                    /* returns */ "transaction_builder",
                    /* params: */{
                        {"balance_id", "address", dfdcore::api::required_positional, fc::ovariant()},
                        {"voter_address", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"strategy", "vote_strategy", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"vote_all\""))},
                        {"sign_and_broadcast", "bool", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"true\""))},
                        {"builder_path", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_publish_slate
                dfdcore::api::MethodData wallet_publish_slate_method_metadata{ "wallet_publish_slate", nullptr,
                    /* description */ "Publishes the current wallet delegate slate to the public data associated with the account",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"publishing_account_name", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"paying_account_name", "account_name", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_publish_version
                dfdcore::api::MethodData wallet_publish_version_method_metadata{ "wallet_publish_version", nullptr,
            ...
            {
                // register method wallet_collect_genesis_balances
                dfdcore::api::MethodData wallet_collect_genesis_balances_method_metadata{ "wallet_collect_genesis_balances", nullptr,
            ...
            {
                // register method wallet_recover_accounts
                dfdcore::api::MethodData wallet_recover_accounts_method_metadata{ "wallet_recover_accounts", nullptr,
                    ...
                    /* returns */ "int32_t",
                    /* params: */{
                        {"accounts_to_recover", "int32_t", dfdcore::api::required_positional, fc::ovariant()},
                        {"maximum_number_of_attempts", "int32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("1000"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_verify_titan_deposit
                dfdcore::api::MethodData wallet_verify_titan_deposit_method_metadata{ "wallet_verify_titan_deposit", nullptr,
            ...
            {
                // register method wallet_repair_entrys
                dfdcore::api::MethodData wallet_repair_entrys_method_metadata{ "wallet_repair_entrys", nullptr,
                    /* description */ "tries to repair any inconsistent wallet account, key, and transaction entrys",
                    /* returns */ "void",
                    /* params: */{
                        {"collecting_account_name", "account_name", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_regenerate_keys
                dfdcore::api::MethodData wallet_regenerate_keys_method_metadata{ "wallet_regenerate_keys", nullptr,
                    /* description */ "regenerates private keys as part of wallet recovery",
                    /* returns */ "int32_t",
                    /* params: */{
                        {"account_name", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"max_key_number", "uint32_t", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_account_retract
                dfdcore::api::MethodData wallet_account_retract_method_metadata{ "wallet_account_retract", nullptr,
                    /* description */ "Retract (permanently disable) the specified account in case of master key compromise.",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"account_to_retract", "account_name", dfdcore::api::required_positional, fc::ovariant()},
                        {"pay_from_account", "account_name", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_account_delete
                dfdcore::api::MethodData wallet_account_delete_method_metadata{ "wallet_account_delete", nullptr,
            ...
            {
                // register method wallet_transfer_to_address_rpc
                dfdcore::api::MethodData wallet_transfer_to_address_rpc_method_metadata{ "wallet_transfer_to_address_rpc", nullptr,
                    /* description */ "Do a simple (non-TITAN) transfer to an address",
                    /* returns */ "string",
                    /* params: */{
                        {"amount_to_transfer", "string", dfdcore::api::required_positional, fc::ovariant()},
            ...
            {
                // register method wallet_account_balance_rpc
                dfdcore::api::MethodData wallet_account_balance_rpc_method_metadata{ "wallet_account_balance_rpc", nullptr,
                    /* description */ "Lists the total asset balances for the specified account",
                    /* returns */ "string",
                    /* params: */{
                        {"account_name", "account_name", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
            ...
            {
                // register method wallet_transfer_to_public_account_rpc
                dfdcore::api::MethodData wallet_transfer_to_public_account_rpc_method_metadata{ "wallet_transfer_to_public_account_rpc", nullptr,
                    /* description */ "Sends given amount to the given account",
                    /* returns */ "string",
                    /* params: */{
                        {"amount_to_transfer", "string", dfdcore::api::required_positional, fc::ovariant()},
            ...
            {
                // register method wallet_get_account_owner_publickey
                dfdcore::api::MethodData wallet_get_account_owner_publickey_method_metadata{ "wallet_get_account_owner_publickey", nullptr,
            ...
            {
                // register method wallet_transfer_to_contract
                dfdcore::api::MethodData wallet_transfer_to_contract_method_metadata{ "wallet_transfer_to_contract", nullptr,
                    /* description */ "Do a simple transfer to a contract (name or address)",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"amount_to_transfer", "real_amount", dfdcore::api::required_positional, fc::ovariant()},
            ...
            {
                // register method wallet_transfer_to_contract_testing
                dfdcore::api::MethodData wallet_transfer_to_contract_testing_method_metadata{ "wallet_transfer_to_contract_testing", nullptr,
            ...
            {
                // register method wallet_get_contracts
                dfdcore::api::MethodData wallet_get_contracts_method_metadata{ "wallet_get_contracts", nullptr,
            ...
            {
                // register method wallet_scan_contracts
                dfdcore::api::MethodData wallet_scan_contracts_method_metadata{ "wallet_scan_contracts", nullptr,
            ...
            {
                // register method wallet_builder_add_signature
                dfdcore::api::MethodData wallet_builder_add_signature_method_metadata{ "wallet_builder_add_signature", nullptr,
                    /* description */ "Review a transaction and add a signature.",
                    /* returns */ "transaction_builder",
                    /* params: */{
                        {"builder", "transaction_builder", dfdcore::api::required_positional, fc::ovariant()},
                        {"broadcast", "bool", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("false"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_builder_file_add_signature
                dfdcore::api::MethodData wallet_builder_file_add_signature_method_metadata{ "wallet_builder_file_add_signature", nullptr,
                    /* description */ "Review a transaction in a builder file and add a signature.",
                    /* returns */ "transaction_builder",
                    /* params: */{
                        {"builder_path", "path", dfdcore::api::required_positional, fc::ovariant()},
                        {"broadcast", "bool", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("false"))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_multisig_deposit
                dfdcore::api::MethodData wallet_multisig_deposit_method_metadata{ "wallet_multisig_deposit", nullptr,
                    /* description */ "transfer to multisig account",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"amount", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "asset_symbol", dfdcore::api::required_positional, fc::ovariant()},
                        {"from_account", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"to_account", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"memo_message", "information", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_import_multisig_account
                dfdcore::api::MethodData wallet_import_multisig_account_method_metadata{ "wallet_import_multisig_account", nullptr,
                    /* description */ "import multisig account,if address exist return multisig detail",
                    /* returns */ "variant_object",
                    /* params: */{
                        {"multisig_address", "address", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_import_multisig_account_by_detail
                dfdcore::api::MethodData wallet_import_multisig_account_by_detail_method_metadata{ "wallet_import_multisig_account_by_detail", nullptr,
                    /* description */ "get multisig account address and import address",
                    /* returns */ "address",
                    /* params: */{
                        {"asset_symbol", "asset_symbol", dfdcore::api::required_positional, fc::ovariant()},
                        {"m", "uint32_t", dfdcore::api::required_positional, fc::ovariant()},
                        {"addresses", "address_list", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_multisig_withdraw_start
                dfdcore::api::MethodData wallet_multisig_withdraw_start_method_metadata{ "wallet_multisig_withdraw_start", nullptr,
                    /* description */ "transfer to normal account from multisig account",
                    /* returns */ "transaction_builder",
                    /* params: */{
                        {"amount", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "asset_symbol", dfdcore::api::required_positional, fc::ovariant()},
                        {"from", "address", dfdcore::api::required_positional, fc::ovariant()},
                        {"to_address", "address", dfdcore::api::required_positional, fc::ovariant()},
                        {"memo_message", "information", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"builder_path", "path", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method wallet_create_multisig_account
                dfdcore::api::MethodData wallet_create_multisig_account_method_metadata{ "wallet_create_multisig_account", nullptr,
                    /* description */ "transfer to multisig account",
            ...
            {
                // register method wallet_multisig_account_history
                dfdcore::api::MethodData wallet_multisig_account_history_method_metadata{ "wallet_multisig_account_history", nullptr,
                    /* description */ "Lists multisig account transaction history for the specified account",
                    /* returns */ "pretty_transactions",
                    /* params: */{
                        {"account_address", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))},
                        {"limit", "int32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("0"))},
                        {"start_block_num", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("0"))},
                        {"end_block_num", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("-1"))}
            ...
            {
                // register method wallet_multisig_account_balance
                dfdcore::api::MethodData wallet_multisig_account_balance_method_metadata{ "wallet_multisig_account_balance", nullptr,
                    /* description */ "Lists the total asset balances for the specified account",
                    /* returns */ "account_balance_summary_type",
                    /* params: */{
                        {"account_address", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_builder_get_multisig_detail
                dfdcore::api::MethodData wallet_builder_get_multisig_detail_method_metadata{ "wallet_builder_get_multisig_detail", nullptr,
                    /* description */ "get builder signature details",
                    /* returns */ "variant_object",
                    /* params: */{
                        {"transaction_builder", "transaction_builder", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 2,
            ...
            {
                // register method wallet_builder_file_get_multisig_detail
                dfdcore::api::MethodData wallet_builder_file_get_multisig_detail_method_metadata{ "wallet_builder_file_get_multisig_detail", nullptr,
                    /* description */ "get builder signature details",
                    /* returns */ "variant_object",
                    /* params: */{
                        {"builder_path", "path", dfdcore::api::required_positional, fc::ovariant()}
            ...
            {
                // register method about
                dfdcore::api::MethodData about_method_metadata{ "about", nullptr,
            ...
            {
                // register method get_info
                dfdcore::api::MethodData get_info_method_metadata{ "get_info", nullptr,
                    /* description */ "Returns version number and associated information for this client",
                    /* returns */ "json_object",
                    /* params: */{                    },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method stop
                dfdcore::api::MethodData stop_method_metadata{ "stop", nullptr,
            ...
            {
                // register method help
                dfdcore::api::MethodData help_method_metadata{ "help", nullptr,
                    /* description */ "display a list of commands, or detailed help on an individual command",
                    /* returns */ "string",
                    /* params: */{
                        {"command_name", "method_name", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method validate_address
                dfdcore::api::MethodData validate_address_method_metadata{ "validate_address", nullptr,
                    /* description */ "Return information about given Dfd address",
                    /* returns */ "json_object",
                    /* params: */{
                        {"address", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
                    /* detailed description */ "Return information about given Dfd address\n\nParameters:\n  address (string, required): the address or public key to validate\n\nReturns:\n  json_object\n",
            ...
            {
                // register method execute_command_line
                dfdcore::api::MethodData execute_command_line_method_metadata{ "execute_command_line", nullptr,
                    /* description */ "Execute the given command as if it were typed on the CLI",
                    /* returns */ "string",
                    /* params: */{
                        {"input", "passphrase", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method execute_script
                dfdcore::api::MethodData execute_script_method_metadata{ "execute_script", nullptr,
                    /* description */ "Execute the given file as if it were typed on the CLI",
                    /* returns */ "void",
                    /* params: */{
                        {"script", "filename", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method batch
                dfdcore::api::MethodData batch_method_metadata{ "batch", nullptr,
                    ...
                    /* returns */ "variants",
                    /* params: */{
                        {"method_name", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"parameters_list", "parameters_list", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method batch_authenticated
                dfdcore::api::MethodData batch_authenticated_method_metadata{ "batch_authenticated", nullptr,
            ...
            {
                // register method builder_finalize_and_sign
                dfdcore::api::MethodData builder_finalize_and_sign_method_metadata{ "builder_finalize_and_sign", nullptr,
                    /* description */ "Takes a transaction builder and returns a signed transaction for broadcasting",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"builder", "transaction_builder", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 5,
            ...
            {
                // register method meta_help
                dfdcore::api::MethodData meta_help_method_metadata{ "meta_help", nullptr,
            ...
            {
                // register method rpc_set_username
                dfdcore::api::MethodData rpc_set_username_method_metadata{ "rpc_set_username", nullptr,
                    /* description */ "Set the username for basic auth for the http server.",
                    /* returns */ "void",
                    /* params: */{
                        {"username", "string", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method rpc_set_password
                dfdcore::api::MethodData rpc_set_password_method_metadata{ "rpc_set_password", nullptr,
                    /* description */ "Set the password for basic auth for the http server.",
                    /* returns */ "void",
                    /* params: */{
                        {"password", "passphrase", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method rpc_start_server
                dfdcore::api::MethodData rpc_start_server_method_metadata{ "rpc_start_server", nullptr,
                    /* description */ "Set the port and start rpc server.",
                    /* returns */ "void",
                    /* params: */{
                        {"port", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"65065\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method http_start_server
                dfdcore::api::MethodData http_start_server_method_metadata{ "http_start_server", nullptr,
                    /* description */ "Set the port and start http server.",
                    /* returns */ "void",
                    /* params: */{
                        {"port", "uint32_t", dfdcore::api::optional_positional, fc::variant(fc::json::from_string("\"65066\""))}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 1,
            ...
            {
                // register method ntp_update_time
                dfdcore::api::MethodData ntp_update_time_method_metadata{ "ntp_update_time", nullptr,
            ...
            {
                // register method disk_usage
                dfdcore::api::MethodData disk_usage_method_metadata{ "disk_usage", nullptr,
            ...
            {
                // register method contract_compile
                dfdcore::api::MethodData contract_compile_method_metadata{ "contract_compile", nullptr,
                    /* description */ "compile contract source code to byte code, and store to binary file",
                    /* returns */ "filename",
                    /* params: */{
                        {"filename", "filename", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method contract_register
                dfdcore::api::MethodData contract_register_method_metadata{ "contract_register", nullptr,
                    /* description */ "register a temporary contract",
                    /* returns */ "string",
                    /* params: */{
                        {"owner", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"codefile", "filename", dfdcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"init_limit", "optional_double", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method contract_register_testing
                dfdcore::api::MethodData contract_register_testing_method_metadata{ "contract_register_testing", nullptr,
            ...
            {
                // register method contract_upgrade
                dfdcore::api::MethodData contract_upgrade_method_metadata{ "contract_upgrade", nullptr,
                    /* description */ "upgrade temporary contract to permanent contract",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"contract_address", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"upgrader_name", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"new_contract_name", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"new_contract_desc", "information", dfdcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"exec_limit", "optional_double", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method contract_upgrade_testing
                dfdcore::api::MethodData contract_upgrade_testing_method_metadata{ "contract_upgrade_testing", nullptr,
            ...
            {
                // register method contract_destroy
                dfdcore::api::MethodData contract_destroy_method_metadata{ "contract_destroy", nullptr,
                    /* description */ "destroy temporary contract",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"contract_address", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"destroyer_name", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"exec_limit", "optional_double", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method contract_destroy_testing
                dfdcore::api::MethodData contract_destroy_testing_method_metadata{ "contract_destroy_testing", nullptr,
            ...
            {
                // register method contract_call
                dfdcore::api::MethodData contract_call_method_metadata{ "contract_call", nullptr,
                    /* description */ "call contract by contract name or contract address",
                    /* returns */ "transaction_entry",
                    /* params: */{
                        {"contract", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"caller_name", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"function_name", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"params", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"call_limit", "optional_double", dfdcore::api::required_positional, fc::ovariant()}
            ...
            {
                // register method contract_get_info
                dfdcore::api::MethodData contract_get_info_method_metadata{ "contract_get_info", nullptr,
            ...
            {
                // register method contract_get_balance
                dfdcore::api::MethodData contract_get_balance_method_metadata{ "contract_get_balance", nullptr,
            ...
            {
                // register method contract_call_testing
                dfdcore::api::MethodData contract_call_testing_method_metadata{ "contract_call_testing", nullptr,
            ...
            {
                // register method contract_call_offline
                dfdcore::api::MethodData contract_call_offline_method_metadata{ "contract_call_offline", nullptr,
            ...
            {
                // register method contract_load_to_file
                dfdcore::api::MethodData contract_load_to_file_method_metadata{ "contract_load_to_file", nullptr,
                    /* description */ "save contract to file",
                    /* returns */ "contract_entry_printable",
                    /* params: */{
                        {"contract", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"file", "filename", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method get_result_trx_id
                dfdcore::api::MethodData get_result_trx_id_method_metadata{ "get_result_trx_id", nullptr,
                    /* description */ "get result tranraction id according to request trx id",
                    /* returns */ "transaction_id",
                    /* params: */{
                        {"request_id", "transaction_id", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method get_request_trx_id
                dfdcore::api::MethodData get_request_trx_id_method_metadata{ "get_request_trx_id", nullptr,
            ...
            {
                // register method simulator_open
                dfdcore::api::MethodData simulator_open_method_metadata{ "simulator_open", nullptr,
            ...
            {
                // register method simulator_close
                dfdcore::api::MethodData simulator_close_method_metadata{ "simulator_close", nullptr,
            ...
            {
                // register method simulator_contract_register
                dfdcore::api::MethodData simulator_contract_register_method_metadata{ "simulator_contract_register", nullptr,
                    ...
                    /* params: */{
                        ...
                        {"codefile", "filename", dfdcore::api::required_positional, fc::ovariant()},
                        {"asset_symbol", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"initLimit", "optional_double", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 16,
            ...
            {
                // register method simulator_contract_call
                dfdcore::api::MethodData simulator_contract_call_method_metadata{ "simulator_contract_call", nullptr,
                    ...
                    /* params: */{
                        ...
                        {"function_name", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"params", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"cost_asset", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"callLimit", "optional_double", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 16,
            ...
            {
                // register method simulator_contract_upgrade
                dfdcore::api::MethodData simulator_contract_upgrade_method_metadata{ "simulator_contract_upgrade", nullptr,
            ...
            {
                // register method simulator_contract_upgrade_testing
                dfdcore::api::MethodData simulator_contract_upgrade_testing_method_metadata{ "simulator_contract_upgrade_testing", nullptr,
                    /* description */ "in simulator state: upgrade temporary contract to permanent contract",
                    /* returns */ "asset_array",
                    /* params: */{
                        {"contract_address", "string", dfdcore::api::required_positional, fc::ovariant()},
            ...
            {
                // register method simulator_contract_destroy
                dfdcore::api::MethodData simulator_contract_destroy_method_metadata{ "simulator_contract_destroy", nullptr,
            ...
            {
                // register method simulator_contract_destroy_testing
                dfdcore::api::MethodData simulator_contract_destroy_testing_method_metadata{ "simulator_contract_destroy_testing", nullptr,
            ...
            {
                // register method simulator_contract_get_info
                dfdcore::api::MethodData simulator_contract_get_info_method_metadata{ "simulator_contract_get_info", nullptr,
            ...
            {
                // register method simulator_contract_get_balance
                dfdcore::api::MethodData simulator_contract_get_balance_method_metadata{ "simulator_contract_get_balance", nullptr,
            ...
            {
                // register method simulator_transfer_to_contract
                dfdcore::api::MethodData simulator_transfer_to_contract_method_metadata{ "simulator_transfer_to_contract", nullptr,
            ...
            {
                // register method simulator_account_balance
                dfdcore::api::MethodData simulator_account_balance_method_metadata{ "simulator_account_balance", nullptr,
            ...
            {
                // register method simulator_contract_compile
                dfdcore::api::MethodData simulator_contract_compile_method_metadata{ "simulator_contract_compile", nullptr,
            ...
            {
                // register method simulator_contract_load_to_file
                dfdcore::api::MethodData simulator_contract_load_to_file_method_metadata{ "simulator_contract_load_to_file", nullptr,
            ...
            {
                // register method simulator_contract_register_testing
                dfdcore::api::MethodData simulator_contract_register_testing_method_metadata{ "simulator_contract_register_testing", nullptr,
            ...
            {
                // register method simulator_contract_call_testing
                dfdcore::api::MethodData simulator_contract_call_testing_method_metadata{ "simulator_contract_call_testing", nullptr,
            ...
            {
                // register method simulator_transfer_to_contract_testing
                dfdcore::api::MethodData simulator_transfer_to_contract_testing_method_metadata{ "simulator_transfer_to_contract_testing", nullptr,
            ...
            {
                // register method simulator_list_my_addresses
                dfdcore::api::MethodData simulator_list_my_addresses_method_metadata{ "simulator_list_my_addresses", nullptr,
            ...
            {
                // register method get_contract_registered_in_transaction
                dfdcore::api::MethodData get_contract_registered_in_transaction_method_metadata{ "get_contract_registered_in_transaction", nullptr,
                    /* description */ "get id of contract registered in specific transaction",
                    /* returns */ "string",
                    /* params: */{
                        {"trx_id", "transaction_id", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method get_transaction_id_contract_registered
                dfdcore::api::MethodData get_transaction_id_contract_registered_method_metadata{ "get_transaction_id_contract_registered", nullptr,
                    /* description */ "get id of transaction that specific contract registered in ",
                    /* returns */ "transaction_id",
                    /* params: */{
                        {"contract_id", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 0,
            ...
            {
                // register method contract_get_info_from_gpc_file
                dfdcore::api::MethodData contract_get_info_from_gpc_file_method_metadata{ "contract_get_info_from_gpc_file", nullptr,
            ...
            {
                // register method script_compile
                dfdcore::api::MethodData script_compile_method_metadata{ "script_compile", nullptr,
            ...
            {
                // register method script_add
                dfdcore::api::MethodData script_add_method_metadata{ "script_add", nullptr,
                    /* description */ "Add a compiled script to database",
                    /* returns */ "string",
                    /* params: */{
                        {"filename", "filename", dfdcore::api::required_positional, fc::ovariant()},
                        {"description", "information", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method script_remove
                dfdcore::api::MethodData script_remove_method_metadata{ "script_remove", nullptr,
                    /* description */ "Remove a compiled script form database",
                    /* returns */ "void",
                    /* params: */{
                        {"scriptid", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method script_get_info
                dfdcore::api::MethodData script_get_info_method_metadata{ "script_get_info", nullptr,
            ...
            {
                // register method scripts_list
                dfdcore::api::MethodData scripts_list_method_metadata{ "scripts_list", nullptr,
            ...
            {
                // register method script_disable
                dfdcore::api::MethodData script_disable_method_metadata{ "script_disable", nullptr,
            ...
            {
                // register method script_enable
                dfdcore::api::MethodData script_enable_method_metadata{ "script_enable", nullptr,
            ...
            {
                // register method script_import_to_db
                dfdcore::api::MethodData script_import_to_db_method_metadata{ "script_import_to_db", nullptr,
                    /* description */ "import scripts from a database directory",
                    /* returns */ "void",
                    /* params: */{
                        {"dbfile", "filename", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method script_export_from_db
                dfdcore::api::MethodData script_export_from_db_method_metadata{ "script_export_from_db", nullptr,
            ...
            {
                // register method script_get_events_bound
                dfdcore::api::MethodData script_get_events_bound_method_metadata{ "script_get_events_bound", nullptr,
                    /* description */ "get contract id and event which binded with specific script",
                    /* returns */ "string_array",
                    /* params: */{
                        {"script_id", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method script_list_event_handler
                dfdcore::api::MethodData script_list_event_handler_method_metadata{ "script_list_event_handler", nullptr,
                    /* description */ "list all event handlers related with the specified contract id and event type",
                    /* returns */ "scriptid_list",
                    /* params: */{
                        {"contract_id_str", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"event_type", "string", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method script_add_event_handler
                dfdcore::api::MethodData script_add_event_handler_method_metadata{ "script_add_event_handler", nullptr,
                    ...
                    /* params: */{
                        ...
                        {"event_type", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"script_id", "string", dfdcore::api::required_positional, fc::ovariant()},
                        {"index", "uint32_t", dfdcore::api::required_positional, fc::ovariant()}
                          },
                    /* prerequisites */ (dfdcore::api::MethodPrerequisites) 4,
            ...
            {
                // register method script_delete_event_handler
                dfdcore::api::MethodData script_delete_event_handler_method_metadata{ "script_delete_event_handler", nullptr,
        ...
        fc::variant CommonApiRpcServer::direct_invoke_positional_method(const std::string& method_name, const fc::variants& parameters)
        {
            ...
            if (method_name == "blockchain_get_dfd_account_balance_entry")
                return blockchain_get_dfd_account_balance_entry_positional(nullptr, parameters);
