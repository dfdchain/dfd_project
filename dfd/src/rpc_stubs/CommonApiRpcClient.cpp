...
namespace dfdcore {
    namespace rpc_stubs {
        ...
        std::vector<dfdcore::consensus::DfdTrxidBalance> CommonApiRpcClient::blockchain_get_dfd_account_balance_entry(uint32_t block_num)
        {
            fc::variant result = get_json_connection()->async_call("blockchain_get_dfd_account_balance_entry", std::vector<fc::variant>{fc::variant(block_num)}).wait();
            return result.as<std::vector<dfdcore::consensus::DfdTrxidBalance>>();
        }
        ...
        dfdcore::consensus::Asset CommonApiRpcClient::blockchain_calculate_supply(const std::string& asset) const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_calculate_supply", std::vector<fc::variant>{fc::variant(asset)}).wait();
            return result.as<dfdcore::consensus::Asset>();
        }
        ...
        dfdcore::consensus::BlockchainSecurityState CommonApiRpcClient::blockchain_get_security_state() const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_get_security_state", std::vector<fc::variant>{}).wait();
            return result.as<dfdcore::consensus::BlockchainSecurityState>();
        }
        std::vector<dfdcore::consensus::AccountEntry> CommonApiRpcClient::blockchain_list_accounts(const std::string& first_account_name /* = fc::json::from_string("\"\"").as<std::string>() */, uint32_t limit /* = fc::json::from_string("20").as<uint32_t>() */) const
        {
            ...
            return result.as<std::vector<dfdcore::consensus::AccountEntry>>();
        }
        std::vector<dfdcore::consensus::AccountEntry> CommonApiRpcClient::blockchain_list_recently_updated_accounts() const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_list_recently_updated_accounts", std::vector<fc::variant>{}).wait();
            return result.as<std::vector<dfdcore::consensus::AccountEntry>>();
        }
        std::vector<dfdcore::consensus::AccountEntry> CommonApiRpcClient::blockchain_list_recently_registered_accounts() const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_list_recently_registered_accounts", std::vector<fc::variant>{}).wait();
            return result.as<std::vector<dfdcore::consensus::AccountEntry>>();
        }
        std::vector<dfdcore::consensus::AssetEntry> CommonApiRpcClient::blockchain_list_assets(const std::string& first_symbol /* = fc::json::from_string("\"\"").as<std::string>() */, uint32_t limit /* = fc::json::from_string("20").as<uint32_t>() */) const
        {
            ...
            return result.as<std::vector<dfdcore::consensus::AssetEntry>>();
        }
        std::vector<std::pair<dfdcore::consensus::TransactionIdType, dfdcore::consensus::SignedTransaction>> CommonApiRpcClient::blockchain_list_pending_transactions() const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_list_pending_transactions", std::vector<fc::variant>{}).wait();
            return result.as<std::vector<std::pair<dfdcore::consensus::TransactionIdType, dfdcore::consensus::SignedTransaction>>>();
        }
        std::pair<dfdcore::consensus::TransactionIdType, dfdcore::consensus::TransactionEntry> CommonApiRpcClient::blockchain_get_transaction(const std::string& transaction_id_prefix, bool exact /* = fc::json::from_string("false").as<bool>() */) const
        {
            ...
            return result.as<std::pair<dfdcore::consensus::TransactionIdType, dfdcore::consensus::TransactionEntry>>();
        }
        dfdcore::wallet::PrettyTransaction CommonApiRpcClient::blockchain_get_pretty_transaction(const std::string& transaction_id_prefix, bool exact /* = fc::json::from_string("false").as<bool>() */) const
        {
            ...
            return result.as<dfdcore::wallet::PrettyTransaction>();
        }
        dfdcore::wallet::PrettyContractTransaction CommonApiRpcClient::blockchain_get_pretty_contract_transaction(const std::string& transaction_id_prefix, bool exact /* = fc::json::from_string("false").as<bool>() */) const
        {
            ...
            return result.as<dfdcore::wallet::PrettyContractTransaction>();
        }
        fc::optional<dfdcore::consensus::BlockEntry> CommonApiRpcClient::blockchain_get_block(const std::string& block) const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_get_block", std::vector<fc::variant>{fc::variant(block)}).wait();
            return result.as<fc::optional<dfdcore::consensus::BlockEntry>>();
        }
        std::map<dfdcore::consensus::TransactionIdType, dfdcore::consensus::TransactionEntry> CommonApiRpcClient::blockchain_get_block_transactions(const std::string& block) const
        {
            ...
            return result.as<std::map<dfdcore::consensus::TransactionIdType, dfdcore::consensus::TransactionEntry>>();
        }
        fc::optional<dfdcore::consensus::AccountEntry> CommonApiRpcClient::blockchain_get_account(const std::string& account) const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_get_account", std::vector<fc::variant>{fc::variant(account)}).wait();
            return result.as<fc::optional<dfdcore::consensus::AccountEntry>>();
        }
        std::map<dfdcore::consensus::AccountIdType, std::string> CommonApiRpcClient::blockchain_get_slate(const std::string& slate) const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_get_slate", std::vector<fc::variant>{fc::variant(slate)}).wait();
            return result.as<std::map<dfdcore::consensus::AccountIdType, std::string>>();
        }
        dfdcore::consensus::BalanceEntry CommonApiRpcClient::blockchain_get_balance(const dfdcore::consensus::Address& balance_id) const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_get_balance", std::vector<fc::variant>{fc::variant(balance_id)}).wait();
            return result.as<dfdcore::consensus::BalanceEntry>();
        }
        std::unordered_map<dfdcore::consensus::BalanceIdType, dfdcore::consensus::BalanceEntry> CommonApiRpcClient::blockchain_list_balances(const std::string& first_balance_id /* = fc::json::from_string("\"\"").as<std::string>() */, uint32_t limit /* = fc::json::from_string("20").as<uint32_t>() */) const
        {
            ...
            return result.as<std::unordered_map<dfdcore::consensus::BalanceIdType, dfdcore::consensus::BalanceEntry>>();
        }
        std::unordered_map<dfdcore::consensus::BalanceIdType, dfdcore::consensus::BalanceEntry> CommonApiRpcClient::blockchain_list_address_balances(const std::string& addr, const fc::time_point& chanced_since /* = fc::json::from_string("\"1970-1-1T00:00:01\"").as<fc::time_point>() */) const
        {
        ...
        dfdcore::wallet::AccountBalanceSummaryType CommonApiRpcClient::blockchain_get_account_public_balance(const std::string& account_name) const
        {
            ...
            return result.as<dfdcore::wallet::AccountBalanceSummaryType>();
        }
        std::unordered_map<dfdcore::consensus::BalanceIdType, dfdcore::consensus::BalanceEntry> CommonApiRpcClient::blockchain_list_key_balances(const dfdcore::consensus::PublicKeyType& key) const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_list_key_balances", std::vector<fc::variant>{fc::variant(key)}).wait();
            return result.as<std::unordered_map<dfdcore::consensus::BalanceIdType, dfdcore::consensus::BalanceEntry>>();
        }
        fc::optional<dfdcore::consensus::AssetEntry> CommonApiRpcClient::blockchain_get_asset(const std::string& asset) const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_get_asset", std::vector<fc::variant>{fc::variant(asset)}).wait();
            return result.as<fc::optional<dfdcore::consensus::AssetEntry>>();
        }
        std::vector<dfdcore::consensus::AccountEntry> CommonApiRpcClient::blockchain_list_active_delegates(uint32_t first /* = fc::json::from_string("0").as<uint32_t>() */, uint32_t count /* = fc::json::from_string("9").as<uint32_t>() */) const
        {
        ...
        std::vector<dfdcore::consensus::AccountEntry> CommonApiRpcClient::blockchain_list_delegates(uint32_t first /* = fc::json::from_string("0").as<uint32_t>() */, uint32_t count /* = fc::json::from_string("9").as<uint32_t>() */) const
        {
        ...
        std::vector<dfdcore::consensus::BlockEntry> CommonApiRpcClient::blockchain_list_blocks(uint32_t max_block_num /* = fc::json::from_string("-1").as<uint32_t>() */, uint32_t limit /* = fc::json::from_string("20").as<uint32_t>() */)
        {
            ...
            return result.as<std::vector<dfdcore::consensus::BlockEntry>>();
        }
        ...
        std::string CommonApiRpcClient::blockchain_export_fork_graph(uint32_t start_block /* = fc::json::from_string("1").as<uint32_t>() */, uint32_t end_block /* = fc::json::from_string("-1").as<uint32_t>() */, const dfdcore::consensus::FilePath& filename /* = fc::json::from_string("\"\"").as<dfdcore::consensus::FilePath>() */) const
        {
        ...
        std::map<uint32_t, std::vector<dfdcore::consensus::ForkEntry>> CommonApiRpcClient::blockchain_list_forks() const
        {
            fc::variant result = get_json_connection()->async_call("blockchain_list_forks", std::vector<fc::variant>{}).wait();
            return result.as<std::map<uint32_t, std::vector<dfdcore::consensus::ForkEntry>>>();
        }
        std::vector<dfdcore::consensus::SlotEntry> CommonApiRpcClient::blockchain_get_delegate_slot_entrys(const std::string& delegate_name, uint32_t limit /* = fc::json::from_string("\"10\"").as<uint32_t>() */) const
        {
            ...
            return result.as<std::vector<dfdcore::consensus::SlotEntry>>();
        }
        ...
        dfdcore::consensus::Asset CommonApiRpcClient::blockchain_unclaimed_genesis() const
        {
        ...
        void CommonApiRpcClient::blockchain_broadcast_transaction(const dfdcore::consensus::SignedTransaction& trx)
        {
        ...
        std::vector<dfdcore::wallet::ContractTransactionSummary> CommonApiRpcClient::blockchain_list_contract_transaction_history(uint32_t from_block_num, uint32_t block_count, const std::string& contract_id /* = fc::json::from_string("\"\"").as<std::string>() */, uint32_t trx_type /* = fc::json::from_string("\"99\"").as<uint32_t>() */, const std::string& call_method /* = fc::json::from_string("\"\"").as<std::string>() */) const
        {
            ...
            return result.as<std::vector<dfdcore::wallet::ContractTransactionSummary>>();
        }
        ...
        dfdcore::consensus::TransactionIdType CommonApiRpcClient::network_broadcast_transaction(const dfdcore::consensus::SignedTransaction& transaction_to_broadcast)
        {
            ...
            return result.as<dfdcore::consensus::TransactionIdType>();
        }
        ...
        dfdcore::network::MessagePropagationData CommonApiRpcClient::network_get_transaction_propagation_data(const dfdcore::consensus::TransactionIdType& transaction_id)
        {
            ...
            return result.as<dfdcore::network::MessagePropagationData>();
        }
        dfdcore::network::MessagePropagationData CommonApiRpcClient::network_get_block_propagation_data(const dfdcore::consensus::BlockIdType& block_hash)
        {
        ...
        std::vector<dfdcore::network::PotentialPeerEntry> CommonApiRpcClient::network_list_potential_peers() const
        {
            fc::variant result = get_json_connection()->async_call("network_list_potential_peers", std::vector<fc::variant>{}).wait();
            return result.as<std::vector<dfdcore::network::PotentialPeerEntry>>();
        }
        ...
        void CommonApiRpcClient::delegate_blacklist_add_transaction(const dfdcore::consensus::TransactionIdType& id)
        {
        ...
        void CommonApiRpcClient::delegate_blacklist_remove_transaction(const dfdcore::consensus::TransactionIdType& id)
        {
        ...
        void CommonApiRpcClient::delegate_blacklist_add_operation(const dfdcore::consensus::OperationTypeEnum& id)
        {
        ...
        void CommonApiRpcClient::delegate_blacklist_remove_operation(const dfdcore::consensus::OperationTypeEnum& id)
        {
        ...
        std::vector<dfdcore::wallet::PrettyTransaction> CommonApiRpcClient::wallet_account_transaction_history(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */, const std::string& asset_symbol /* = fc::json::from_string("\"\"").as<std::string>() */, int32_t limit /* = fc::json::from_string("0").as<int32_t>() */, uint32_t start_block_num /* = fc::json::from_string("0").as<uint32_t>() */, uint32_t end_block_num /* = fc::json::from_string("-1").as<uint32_t>() */) const
        {
        ...
        dfdcore::wallet::AccountBalanceSummaryType CommonApiRpcClient::wallet_account_historic_balance(const fc::time_point& time, const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */) const
        {
        ...
        std::map<dfdcore::consensus::TransactionIdType, fc::exception> CommonApiRpcClient::wallet_get_pending_transaction_errors(const dfdcore::consensus::FilePath& filename /* = fc::json::from_string("\"\"").as<dfdcore::consensus::FilePath>() */) const
        {
            ...
            return result.as<std::map<dfdcore::consensus::TransactionIdType, fc::exception>>();
        }
        ...
        dfdcore::consensus::Address CommonApiRpcClient::wallet_account_create(const std::string& account_name, const fc::variant& private_data /* = fc::json::from_string("null").as<fc::variant>() */)
        {
            ...
            return result.as<dfdcore::consensus::Address>();
        }
        ...
        std::vector<dfdcore::consensus::AccountEntry> CommonApiRpcClient::wallet_get_all_approved_accounts(int8_t approval /* = fc::json::from_string("1").as<int8_t>() */)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_transfer_to_address(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_address, const dfdcore::consensus::Imessage& memo_message /* = fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>() */, const dfdcore::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_recommended\"").as<dfdcore::wallet::VoteStrategy>() */)
        {
            ...
            return result.as<dfdcore::wallet::WalletTransactionEntry>();
        }
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_transfer_to_public_account(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_account_name, const dfdcore::consensus::Imessage& memo_message /* = fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>() */, const dfdcore::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_recommended\"").as<dfdcore::wallet::VoteStrategy>() */)
        {
        ...
        dfdcore::wallet::TransactionBuilder CommonApiRpcClient::wallet_withdraw_from_address(const std::string& amount, const std::string& symbol, const dfdcore::consensus::Address& from_address, const std::string& to, const dfdcore::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_none\"").as<dfdcore::wallet::VoteStrategy>() */, bool sign_and_broadcast /* = fc::json::from_string("true").as<bool>() */, const std::string& builder_path /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
            ...
            return result.as<dfdcore::wallet::TransactionBuilder>();
        }
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_get_transaction(const std::string& transaction_id)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_scan_transaction(const std::string& transaction_id, bool overwrite_existing /* = fc::json::from_string("false").as<bool>() */)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_account_update_registration(const std::string& account_name, const std::string& pay_from_account, const fc::variant& public_data /* = fc::json::from_string("null").as<fc::variant>() */, uint8_t delegate_pay_rate /* = fc::json::from_string("-1").as<uint8_t>() */)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_account_update_active_key(const std::string& account_to_update, const std::string& pay_from_account, const std::string& new_active_key /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
        ...
        std::vector<dfdcore::wallet::WalletAccountEntry> CommonApiRpcClient::wallet_list_accounts() const
        {
            fc::variant result = get_json_connection()->async_call("wallet_list_accounts", std::vector<fc::variant>{}).wait();
            return result.as<std::vector<dfdcore::wallet::WalletAccountEntry>>();
        }
        std::vector<dfdcore::wallet::WalletAccountEntry> CommonApiRpcClient::wallet_list_unregistered_accounts() const
        {
            fc::variant result = get_json_connection()->async_call("wallet_list_unregistered_accounts", std::vector<fc::variant>{}).wait();
            return result.as<std::vector<dfdcore::wallet::WalletAccountEntry>>();
        }
        std::vector<dfdcore::wallet::WalletAccountEntry> CommonApiRpcClient::wallet_list_my_accounts() const
        {
            fc::variant result = get_json_connection()->async_call("wallet_list_my_accounts", std::vector<fc::variant>{}).wait();
            return result.as<std::vector<dfdcore::wallet::WalletAccountEntry>>();
        }
        std::vector<dfdcore::wallet::AccountAddressData> CommonApiRpcClient::wallet_list_my_addresses() const
        {
            fc::variant result = get_json_connection()->async_call("wallet_list_my_addresses", std::vector<fc::variant>{}).wait();
            return result.as<std::vector<dfdcore::wallet::AccountAddressData>>();
        }
        dfdcore::wallet::WalletAccountEntry CommonApiRpcClient::wallet_get_account(const std::string& account_name) const
        {
            fc::variant result = get_json_connection()->async_call("wallet_get_account", std::vector<fc::variant>{fc::variant(account_name)}).wait();
            return result.as<dfdcore::wallet::WalletAccountEntry>();
        }
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_asset_issue(const std::string& amount, const std::string& symbol, const std::string& to_account_name, const dfdcore::consensus::Imessage& memo_message /* = fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>() */)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_asset_issue_to_addresses(const std::string& symbol, const std::map<std::string, dfdcore::consensus::ShareType>& addresses)
        {
        ...
        dfdcore::wallet::AccountBalanceSummaryType CommonApiRpcClient::wallet_account_balance(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */) const
        {
        ...
        dfdcore::wallet::AccountBalanceIdSummaryType CommonApiRpcClient::wallet_account_balance_ids(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */) const
        {
            ...
            return result.as<dfdcore::wallet::AccountBalanceIdSummaryType>();
        }
        std::vector<dfdcore::wallet::PublicKeySummary> CommonApiRpcClient::wallet_account_list_public_keys(const std::string& account_name)
        {
            ...
            return result.as<std::vector<dfdcore::wallet::PublicKeySummary>>();
        }
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_delegate_withdraw_pay(const std::string& delegate_name, const std::string& to_account_name, const std::string& amount_to_withdraw)
        {
        ...
        dfdcore::consensus::DelegatePaySalary CommonApiRpcClient::wallet_delegate_pay_balance_query(const std::string& delegate_name)
        {
            ...
            return result.as<dfdcore::consensus::DelegatePaySalary>();
        }
        std::map<std::string,dfdcore::consensus::DelegatePaySalary> CommonApiRpcClient::wallet_active_delegate_salary()
        {
            fc::variant result = get_json_connection()->async_call("wallet_active_delegate_salary", std::vector<fc::variant>{}).wait();
            return result.as<std::map<std::string,dfdcore::consensus::DelegatePaySalary>>();
        }
        ...
        dfdcore::consensus::Asset CommonApiRpcClient::wallet_set_transaction_fee(const std::string& fee)
        {
            fc::variant result = get_json_connection()->async_call("wallet_set_transaction_fee", std::vector<fc::variant>{fc::variant(fee)}).wait();
            return result.as<dfdcore::consensus::Asset>();
        }
        dfdcore::consensus::Asset CommonApiRpcClient::wallet_get_transaction_fee(const std::string& symbol /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
        ...
        fc::optional<std::string> CommonApiRpcClient::wallet_dump_account_private_key(const std::string& account_name, const dfdcore::wallet::AccountKeyType& key_type) const
        {
        ...
        dfdcore::wallet::AccountVoteSummaryType CommonApiRpcClient::wallet_account_vote_summary(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */) const
        {
            ...
            return result.as<dfdcore::wallet::AccountVoteSummaryType>();
        }
        dfdcore::wallet::VoteSummary CommonApiRpcClient::wallet_check_vote_status(const std::string& account)
        {
            fc::variant result = get_json_connection()->async_call("wallet_check_vote_status", std::vector<fc::variant>{fc::variant(account)}).wait();
            return result.as<dfdcore::wallet::VoteSummary>();
        }
        ...
        fc::variant CommonApiRpcClient::wallet_login_finish(const dfdcore::consensus::PublicKeyType& server_key, const dfdcore::consensus::PublicKeyType& client_key, const fc::ecc::compact_signature& client_signature)
        {
        ...
        dfdcore::wallet::TransactionBuilder CommonApiRpcClient::wallet_balance_set_vote_info(const dfdcore::consensus::Address& balance_id, const std::string& voter_address /* = fc::json::from_string("\"\"").as<std::string>() */, const dfdcore::wallet::VoteStrategy& strategy /* = fc::json::from_string("\"vote_all\"").as<dfdcore::wallet::VoteStrategy>() */, bool sign_and_broadcast /* = fc::json::from_string("\"true\"").as<bool>() */, const std::string& builder_path /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_publish_slate(const std::string& publishing_account_name, const std::string& paying_account_name /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_publish_version(const std::string& publishing_account_name, const std::string& paying_account_name /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_collect_genesis_balances(const std::string& account_name)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_account_retract(const std::string& account_to_retract, const std::string& pay_from_account)
        {
        ...
        dfdcore::consensus::PublicKeyType CommonApiRpcClient::wallet_get_account_owner_publickey(const std::string& account_name)
        {
            ...
            return result.as<dfdcore::consensus::PublicKeyType>();
        }
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_transfer_to_contract(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract, double amount_for_exec)
        {
        ...
        std::vector<dfdcore::consensus::Asset> CommonApiRpcClient::wallet_transfer_to_contract_testing(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract)
        {
            ...
            return result.as<std::vector<dfdcore::consensus::Asset>>();
        }
        ...
        dfdcore::wallet::TransactionBuilder CommonApiRpcClient::wallet_builder_add_signature(const dfdcore::wallet::TransactionBuilder& builder, bool broadcast /* = fc::json::from_string("false").as<bool>() */)
        {
        ...
        dfdcore::wallet::TransactionBuilder CommonApiRpcClient::wallet_builder_file_add_signature(const dfdcore::consensus::FilePath& builder_path, bool broadcast /* = fc::json::from_string("false").as<bool>() */)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_multisig_deposit(const std::string& amount, const std::string& asset_symbol, const std::string& from_account, const std::string& to_account, const dfdcore::consensus::Imessage& memo_message /* = fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>() */)
        {
        ...
        fc::variant_object CommonApiRpcClient::wallet_import_multisig_account(const dfdcore::consensus::Address& multisig_address)
        {
        ...
        dfdcore::consensus::Address CommonApiRpcClient::wallet_import_multisig_account_by_detail(const std::string& asset_symbol, uint32_t m, const std::vector<dfdcore::consensus::Address>& addresses)
        {
        ...
        dfdcore::wallet::TransactionBuilder CommonApiRpcClient::wallet_multisig_withdraw_start(const std::string& amount, const std::string& asset_symbol, const dfdcore::consensus::Address& from, const dfdcore::consensus::Address& to_address, const dfdcore::consensus::Imessage& memo_message /* = fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>() */, const dfdcore::consensus::FilePath& builder_path /* = fc::json::from_string("\"\"").as<dfdcore::consensus::FilePath>() */)
        {
        ...
        std::pair<std::string, dfdcore::wallet::WalletTransactionEntry> CommonApiRpcClient::wallet_create_multisig_account(const std::string& amount, const std::string& asset_symbol, const std::string& from_account, uint32_t m, const std::vector<dfdcore::consensus::Address>& addresses, const dfdcore::consensus::Imessage& memo_message /* = fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>() */)
        {
            ...
            return result.as<std::pair<std::string, dfdcore::wallet::WalletTransactionEntry>>();
        }
        std::vector<dfdcore::wallet::PrettyTransaction> CommonApiRpcClient::wallet_multisig_account_history(const std::string& account_address, const std::string& asset_symbol /* = fc::json::from_string("\"\"").as<std::string>() */, int32_t limit /* = fc::json::from_string("0").as<int32_t>() */, uint32_t start_block_num /* = fc::json::from_string("0").as<uint32_t>() */, uint32_t end_block_num /* = fc::json::from_string("-1").as<uint32_t>() */) const
        {
        ...
        dfdcore::wallet::AccountBalanceSummaryType CommonApiRpcClient::wallet_multisig_account_balance(const std::string& account_address /* = fc::json::from_string("\"\"").as<std::string>() */) const
        {
        ...
        fc::variant_object CommonApiRpcClient::wallet_builder_get_multisig_detail(const dfdcore::wallet::TransactionBuilder& transaction_builder) const
        {
        ...
        fc::variant_object CommonApiRpcClient::wallet_builder_file_get_multisig_detail(const dfdcore::consensus::FilePath& builder_path) const
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::builder_finalize_and_sign(const dfdcore::wallet::TransactionBuilder& builder) const
        {
            fc::variant result = get_json_connection()->async_call("builder_finalize_and_sign", std::vector<fc::variant>{fc::variant(builder)}).wait();
            return result.as<dfdcore::wallet::WalletTransactionEntry>();
        }
        std::map<std::string, dfdcore::api::MethodData> CommonApiRpcClient::meta_help() const
        {
            fc::variant result = get_json_connection()->async_call("meta_help", std::vector<fc::variant>{}).wait();
            return result.as<std::map<std::string, dfdcore::api::MethodData>>();
        }
        ...
        std::vector<dfdcore::consensus::Asset> CommonApiRpcClient::contract_register_testing(const std::string& owner, const fc::path& codefile)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::contract_upgrade(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const dfdcore::consensus::Imessage& new_contract_desc, const std::string& asset_symbol, const fc::optional<double>& exec_limit)
        {
        ...
        std::vector<dfdcore::consensus::Asset> CommonApiRpcClient::contract_upgrade_testing(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const dfdcore::consensus::Imessage& new_contract_desc)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::contract_destroy(const std::string& contract_address, const std::string& destroyer_name, const std::string& asset_symbol, const fc::optional<double>& exec_limit)
        {
        ...
        std::vector<dfdcore::consensus::Asset> CommonApiRpcClient::contract_destroy_testing(const std::string& contract_address, const std::string& destroyer_name)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::contract_call(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params, const std::string& asset_symbol, const fc::optional<double>& call_limit)
        {
        ...
        dfdcore::consensus::ContractEntryPrintable CommonApiRpcClient::contract_get_info(const std::string& contract)
        {
            fc::variant result = get_json_connection()->async_call("contract_get_info", std::vector<fc::variant>{fc::variant(contract)}).wait();
            return result.as<dfdcore::consensus::ContractEntryPrintable>();
        }
        std::vector<dfdcore::consensus::BalanceEntry> CommonApiRpcClient::contract_get_balance(const std::string& contract)
        {
            fc::variant result = get_json_connection()->async_call("contract_get_balance", std::vector<fc::variant>{fc::variant(contract)}).wait();
            return result.as<std::vector<dfdcore::consensus::BalanceEntry>>();
        }
        std::vector<dfdcore::consensus::Asset> CommonApiRpcClient::contract_call_testing(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params)
        {
        ...
        dfdcore::consensus::ContractEntryPrintable CommonApiRpcClient::contract_load_to_file(const std::string& contract, const fc::path& file)
        {
        ...
        dfdcore::consensus::TransactionIdType CommonApiRpcClient::get_result_trx_id(const dfdcore::consensus::TransactionIdType& request_id)
        {
            fc::variant result = get_json_connection()->async_call("get_result_trx_id", std::vector<fc::variant>{fc::variant(request_id)}).wait();
            return result.as<dfdcore::consensus::TransactionIdType>();
        }
        dfdcore::consensus::TransactionIdType CommonApiRpcClient::get_request_trx_id(const dfdcore::consensus::TransactionIdType& request_id)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::simulator_contract_call(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params, const std::string& cost_asset, const fc::optional<double>& callLimit)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::simulator_contract_upgrade(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const dfdcore::consensus::Imessage& new_contract_desc, const std::string& asset_symbol, const fc::optional<double>& exec_limit)
        {
        ...
        std::vector<dfdcore::consensus::Asset> CommonApiRpcClient::simulator_contract_upgrade_testing(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const dfdcore::consensus::Imessage& new_contract_desc)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::simulator_contract_destroy(const std::string& contract_address, const std::string& destroyer_name, const std::string& asset_symbol, const fc::optional<double>& exec_limit)
        {
        ...
        std::vector<dfdcore::consensus::Asset> CommonApiRpcClient::simulator_contract_destroy_testing(const std::string& contract_address, const std::string& destroyer_name)
        {
        ...
        dfdcore::consensus::ContractEntryPrintable CommonApiRpcClient::simulator_contract_get_info(const std::string& contract)
        {
        ...
        std::vector<dfdcore::consensus::BalanceEntry> CommonApiRpcClient::simulator_contract_get_balance(const std::string& contract)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::simulator_transfer_to_contract(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract, double amount_for_exec)
        {
        ...
        dfdcore::wallet::AccountBalanceSummaryType CommonApiRpcClient::simulator_account_balance(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
        ...
        dfdcore::consensus::ContractEntryPrintable CommonApiRpcClient::simulator_contract_load_to_file(const std::string& contract, const fc::path& file)
        {
        ...
        std::vector<dfdcore::consensus::Asset> CommonApiRpcClient::simulator_contract_register_testing(const std::string& owner, const fc::path& codefile)
        {
        ...
        std::vector<dfdcore::consensus::Asset> CommonApiRpcClient::simulator_contract_call_testing(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params)
        {
        ...
        std::vector<dfdcore::consensus::Asset> CommonApiRpcClient::simulator_transfer_to_contract_testing(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract)
        {
        ...
        vector<dfdcore::consensus::SimulatorAccountInfo> CommonApiRpcClient::simulator_list_my_addresses(const std::string& account_name /* = fc::json::from_string("\"\"").as<std::string>() */)
        {
            ...
            return result.as<vector<dfdcore::consensus::SimulatorAccountInfo>>();
        }
        std::string CommonApiRpcClient::get_contract_registered_in_transaction(const dfdcore::consensus::TransactionIdType& trx_id)
        {
        ...
        dfdcore::consensus::TransactionIdType CommonApiRpcClient::get_transaction_id_contract_registered(const std::string& contract_id)
        {
        ...
        dfdcore::consensus::CodePrintAble CommonApiRpcClient::contract_get_info_from_gpc_file(const fc::path& file)
        {
            ...
            return result.as<dfdcore::consensus::CodePrintAble>();
        }
        ...
        std::string CommonApiRpcClient::script_add(const fc::path& filename, const dfdcore::consensus::Imessage& description)
        {
        ...
        dfdcore::wallet::ScriptEntryPrintable CommonApiRpcClient::script_get_info(const std::string& scriptid)
        {
            fc::variant result = get_json_connection()->async_call("script_get_info", std::vector<fc::variant>{fc::variant(scriptid)}).wait();
            return result.as<dfdcore::wallet::ScriptEntryPrintable>();
        }
        std::vector<dfdcore::wallet::ScriptEntryPrintable> CommonApiRpcClient::scripts_list()
        {
            fc::variant result = get_json_connection()->async_call("scripts_list", std::vector<fc::variant>{}).wait();
            return result.as<std::vector<dfdcore::wallet::ScriptEntryPrintable>>();
        }
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_call_contract_build(const std::string& contract, const std::string& caller_publickey, const std::string& function_name, const std::string& params, const std::string& asset_symbol, const fc::optional<double>& call_limit)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::sign_build_transaction(const dfdcore::wallet::WalletTransactionEntry& trasaction_building)
        {
		...
		std::string CommonApiRpcClient::broadcast_building_transaction(const dfdcore::wallet::WalletTransactionEntry& trasaction_building)
        {
        ...
        dfdcore::wallet::WalletTransactionEntry CommonApiRpcClient::wallet_transfer_to_contract_build(const string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_public_key, const std::string& to_contract, double amount_for_exec)
        {
