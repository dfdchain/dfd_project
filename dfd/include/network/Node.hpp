...
namespace dfdcore {
    namespace network {
        ...
        public:
             ...
             */
            virtual bool has_item(const dfdcore::network::ItemId& id) = 0;
             ...
             */
            virtual std::vector<ItemHashType> get_blockchain_synopsis(uint32_t item_type, const dfdcore::network::ItemHashType& reference_point = dfdcore::network::ItemHashType(), uint32_t number_of_blocks_after_reference_point = 0) = 0;
...
FC_REFLECT(dfdcore::network::MessagePropagationData, (received_time)(validated_time)(originating_peer));
