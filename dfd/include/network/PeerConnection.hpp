...
namespace dfdcore {
    namespace network
    {
        ...
        public:
            ...
            fc::optional<std::string> dfdcore_git_revision_sha;
            fc::optional<fc::time_point_sec> dfdcore_git_revision_unix_timestamp;
...
FC_REFLECT_ENUM(dfdcore::network::PeerConnection::OurConnectionState, (disconnected)
    (just_connected)
    (connection_accepted)
    (connection_rejected))
    FC_REFLECT_ENUM(dfdcore::network::PeerConnection::TheirConnectionState, (disconnected)
    (just_connected)
    (connection_accepted)
    (connection_rejected))
    FC_REFLECT_ENUM(dfdcore::network::PeerConnection::ConnectionNegotiationStatus, (disconnected)
    (connecting)
    (connected)
    (accepting)
    (accepted)
