...
namespace dfdcore {
    namespace client {
        ...
        //    using dfdcore::mail::mail_client_ptr;
        //    using dfdcore::mail::mail_server_ptr;
        ...
        struct Config
        {
            ...
            uint16_t            maximum_number_of_connections = DFD_NET_DEFAULT_MAX_CONNECTIONS;
            bool                use_upnp = true;
            ...
            ShareType          min_relay_fee = DFD_BLOCKCHAIN_DEFAULT_RELAY_FEE;
            string              wallet_callback_url;

            ShareType          light_network_fee = DFD_BLOCKCHAIN_DEFAULT_RELAY_FEE;
            ShareType          light_relay_fee = DFD_BLOCKCHAIN_DEFAULT_RELAY_FEE;
            ...
            optional<string>    growl_dfd_client_identifier;
         ...
         *
         */
        class Client : public dfdcore::rpc_stubs::CommonApiClient,
        ...
        public:
            ...
            dfdcore::rpc::RpcServerPtr   get_rpc_server()const;
            dfdcore::network::NodePtr         get_node()const;
            fc::path                   get_data_dir()const;

            // returns true if the client is connected to the network
            bool                is_connected() const;
            dfdcore::network::NodeIdType get_node_id() const;
            ...
            bool handle_message(const dfdcore::network::Message&, bool sync_mode);
            void sync_status(uint32_t item_type, uint32_t item_count);
            DelegateConfig get_delegate_config();
        protected:
            virtual dfdcore::api::CommonApi* get_impl() const override;
...
extern const std::string DFD_MESSAGE_MAGIC;

FC_REFLECT(dfdcore::client::ClientNotification, (timestamp)(message)(signature))
FC_REFLECT(dfdcore::client::RpcServerConfig, (enable)(enable_cache)(rpc_user)(rpc_password)(rpc_endpoint)(httpd_endpoint)
(encrypted_rpc_endpoint)(encrypted_rpc_wif_key)(htdocs))
FC_REFLECT(dfdcore::client::ChainServerConfig, (enabled)(listen_port))
FC_REFLECT(dfdcore::client::Config,
(logging)
(ignore_console)
(client_debug_name)
(rpc)
