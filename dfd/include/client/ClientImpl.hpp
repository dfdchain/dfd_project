...
namespace dfdcore {
    namespace client {
        ...
        namespace detail {
            ...
            {
            public:
                typedef dfdcore::db::LevelMap<fc::time_point, fc::exception> ExceptionLeveldbType;
            private:
            ...
            public:
                void open(const fc::path& filename)
                {
                    ...
                    catch (const dfdcore::db::level_map_open_failure&)
                    {
            ...
            class ClientImpl : public dfdcore::network::NodeDelegate,
                public dfdcore::api::CommonApi
            {
            public:
                ...
                ClientImpl(dfdcore::client::Client* self, const std::string& user_agent) :
                    _self(self),
                    ...
                    _blockchain_synopsis_size_limit((unsigned)(log2(DFD_BLOCKCHAIN_BLOCKS_PER_YEAR * 20))),
                    _debug_last_wait_block(0)
                {
                    try
                    {
                        if (uvm::lua::api::global_uvm_chain_api == nullptr)
                            uvm::lua::api::global_uvm_chain_api = new dfdcore::lua::api::UvmChainApi;
                ...
                */
				...
				dfdcore::consensus::TransactionIdType network_broadcast_transactions(const std::vector<dfdcore::consensus::SignedTransaction>& transactions_to_broadcast);
                ...
                // @{
				virtual bool has_item(const dfdcore::network::ItemId& id) override;
				fc::time_point_sec handle_ntp_time(bool need_update)override;
                virtual bool handle_message(const dfdcore::network::Message&, bool sync_mode) override;
                virtual std::vector<dfdcore::network::ItemHashType> get_item_ids(uint32_t item_type,
                    const vector<dfdcore::network::ItemHashType>& blockchain_synopsis,
                    uint32_t& remaining_item_count,
                    uint32_t limit = 2000) override;
                virtual dfdcore::network::Message get_item(const dfdcore::network::ItemId& id) override;
                virtual fc::sha256 get_chain_id() const override
                {
                    FC_ASSERT(_chain_db != nullptr);
                    return _chain_db->get_chain_id();
                }
                virtual std::vector<dfdcore::network::ItemHashType> get_blockchain_synopsis(uint32_t item_type,
                ...
                virtual uint32_t get_block_number(const dfdcore::network::ItemHashType& block_id) override;
                virtual fc::time_point_sec get_block_time(const dfdcore::network::ItemHashType& block_id) override;
                virtual fc::time_point_sec get_blockchain_now() override;
                virtual dfdcore::network::ItemHashType get_head_block_id() const override;
                ...
                dfdcore::client::Client*                                    _self;
                std::string                                             _user_agent;
                dfdcore::console::Cli*                                          _cli = nullptr;
                ...
                dfdcore::rpc::RpcServerPtr                                _rpc_server = nullptr;
                //std::unique_ptr<dfdcore::network::ChainServer>                 _chain_server = nullptr;
                std::unique_ptr<dfdcore::network::UpnpService>                 _upnp_service = nullptr;
                ...
                //  std::shared_ptr<dfdcore::mail::server>                      _mail_server = nullptr;
                // std::shared_ptr<dfdcore::mail::client>                      _mail_client = nullptr;
                ...
                dfdcore::network::NodePtr                                      _p2p_node = nullptr;
                bool                                                    _simulated_network = false;

                DfdGntpNotifierPtr                                   _notifier;
                ...
                // include all of the method overrides generated by the dfd_api_generator
