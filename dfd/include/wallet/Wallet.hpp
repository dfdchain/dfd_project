...
#define INVALIDE_SDFD_ADDRESS ("ffffffffffffffffffffffffffffffff")
namespace dfdcore {
    namespace wallet {
        ...
        public:
           ...
           */
            ...
            */
            ...
            dfdcore::wallet::WalletTransactionEntry transfer_asset_to_contract_without_signature(
                const string& real_amount_to_transfer,
                const string& amount_to_transfer_symbol,
            ...
            *
            * @param wif_key A private key in dfdcore wallet import format
            ...
            * @param amount_to_transfer_symbol the asset to transfer like DFD 
            ...
            * @param dfd_account centralized system address
            *
            * @return WalletTransactionEntry
            */
            ...
            std::vector<dfdcore::consensus::Asset> transfer_asset_to_contract_testing(
                const string& real_amount_to_transfer,
                const string& amount_to_transfer_symbol,
                const string& from_account_name,
                const Address& to_contract_address,
			...
			std::vector<dfdcore::consensus::Asset> contract_upgrade_testing(
				const Address& contract_id,
				const string& upgrader_name,
				const string& contract_name,
				const string& contract_desc,
			...
			std::vector<dfdcore::consensus::Asset> contract_destroy_testing(
				const Address& contract_id,
				const string& destroyer_name,
				bool sign = true
				);
            ...
            */
            WalletTransactionEntry register_account(
                ...
                dfdcore::consensus::AccountType new_account_type,
                bool sign
                );
            /**
            ...
            */
            DelegatePaySalary query_delegate_salary(
                const string& delegate_name);
            std::map<std::string, dfdcore::consensus::DelegatePaySalary> query_delegate_salarys();
            ...
            * @return string
            */
            PrettyTransaction				    to_pretty_trx(const dfdcore::consensus::TransactionEntry& trx_entry, const std::string addr_for_fee) const;


            PrettyContractTransaction           to_pretty_contract_trx(const dfdcore::consensus::TransactionEntry& trx_entry) const;
            ...
            */
            ...
            std::vector<dfdcore::consensus::Asset> contract_register_testing(const string& owner, const fc::path codefile);
            ...
            std::vector<dfdcore::consensus::Asset> contract_call_testing(const string caller, const ContractIdType contract, const string method, const string& arguments);
...
FC_REFLECT_ENUM(dfdcore::wallet::AccountKeyType,
    (owner_key)
    (active_key)
    (signing_key)
    )
