...
namespace dfdcore {
    namespace wallet {
        ...
        public:
            ...
            void                   store_account(const dfdcore::consensus::AccountEntry& blockchain_account_entry, fc::sha512 password = fc::sha512());
            ...
            */
			...
			void store_contract(const dfdcore::consensus::ContractEntry& blockchain_contract_entry);
        ...
        private:
            ...
            unordered_map<Address, Address>                                btc_to_dfd_address;
