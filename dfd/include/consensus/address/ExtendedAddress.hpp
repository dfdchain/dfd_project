...
FC_REFLECT(dfdcore::consensus::ExtendedPublicKey, (pub_key)(chain_code))
FC_REFLECT(dfdcore::consensus::ExtendedPrivateKey, (priv_key)(chain_code))
FC_REFLECT(dfdcore::consensus::ExtendedAddress, (addr))

namespace fc
{
    void to_variant(const dfdcore::consensus::ExtendedAddress& var, fc::variant& vo);
    void from_variant(const fc::variant& var, dfdcore::consensus::ExtendedAddress& vo);
}

namespace std
{
    template<>
    struct hash < dfdcore::consensus::ExtendedAddress >
    {
    public:
        size_t operator()(const dfdcore::consensus::ExtendedAddress &a) const
        {
            size_t s;
            fc::sha1::encoder enc;
            fc::raw::pack(enc, a);
