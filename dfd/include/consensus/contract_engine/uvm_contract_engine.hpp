...
namespace glua
{
	using namespace dfdcore;

	class UvmContractEngine : public dfdcore::consensus::contract_engine::ContractEngine
	{
	private:
	...
	public:
		...
		virtual std::shared_ptr<::dfdcore::consensus::contract_engine::VMModuleByteStream> get_bytestream_from_code(const uvm::blockchain::Code& code);
	};
}
