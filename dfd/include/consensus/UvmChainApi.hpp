		...
		namespace api
		{
			...
			public:
				...
				*/
				...
				/**
				* get contract info stored before from dfdcore api
				...
				*/
				...
				/**
				* get contract address/id from dfdcore by contract name
				*/
				...
				*/
				...
				/**
				* register new storage name of contract to dfdcore
				*/
				virtual bool register_storage(lua_State *L, const char *contract_name, const char *name);

				/**
				* directly get storage value from dfdcore
				*/
				...
				/**
				* after lua merge storage changes in lua_State, use the function to store the merged changes of storage to dfdcore
				*/
