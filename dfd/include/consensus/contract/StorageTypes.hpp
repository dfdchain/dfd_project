...
FC_REFLECT_ENUM(dfdcore::consensus::StorageValueTypes,
    (storage_value_null)
    (storage_value_int)
    ...
    FC_REFLECT(dfdcore::consensus::StorageDataType,
    (storage_type)
    (storage_data)
    )

    FC_REFLECT(dfdcore::consensus::StorageNullType,
    (raw_storage)
    )

    FC_REFLECT(dfdcore::consensus::StorageIntType,
    (raw_storage)
    )

    FC_REFLECT(dfdcore::consensus::StorageBoolType,
    (raw_storage)
    )

    FC_REFLECT(dfdcore::consensus::StorageNumberType,
    (raw_storage)
    )

    FC_REFLECT(dfdcore::consensus::StorageStringType,
    (raw_storage)
    )

    FC_REFLECT(dfdcore::consensus::StorageIntTableType,
    (raw_storage_map)
    )

    FC_REFLECT(dfdcore::consensus::StorageBoolTableType,
    (raw_storage_map)
    )

    FC_REFLECT(dfdcore::consensus::StorageNumberTableType,
    (raw_storage_map)
    )

    FC_REFLECT(dfdcore::consensus::StorageStringTableType,
    (raw_storage_map)
    )

    FC_REFLECT(dfdcore::consensus::StorageIntArrayType,
    (raw_storage_map)
    )

    FC_REFLECT(dfdcore::consensus::StorageBoolArrayType,
    (raw_storage_map)
    )

    FC_REFLECT(dfdcore::consensus::StorageNumberArrayType,
    (raw_storage_map)
    )

    FC_REFLECT(dfdcore::consensus::StorageStringArrayType,
    (raw_storage_map)
    )
