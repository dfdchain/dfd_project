...
FC_REFLECT_ENUM(dfdcore::consensus::ContractApiType,
    (chain)
    (offline)
    (event)
    )

    FC_REFLECT_ENUM(dfdcore::consensus::ContractState,
    (valid)
    (deleted)
    )

    FC_REFLECT_ENUM(dfdcore::consensus::ContractLevel,
    (temp)
    (forever)
    )

    FC_REFLECT(dfdcore::consensus::ContractEntry,
    (contract_name)
    (id)
    (level)
    (owner)
	...
	FC_REFLECT(dfdcore::consensus::ContractIdEntry,
	(id)
		
	)
	

    FC_REFLECT(dfdcore::consensus::ContractEntryPrintable,
    (contract_name)
    (id)
    (level)
    (owner)
    ...
    FC_REFLECT(dfdcore::consensus::ContractStorageEntry, (id)(contract_storages))
	FC_REFLECT(dfdcore::consensus::ResultTIdEntry, (res))
	FC_REFLECT(dfdcore::consensus::RequestIdEntry, (req))
	FC_REFLECT(dfdcore::consensus::ContractTrxEntry, (trx_id))
	FC_REFLECT(dfdcore::consensus::ContractinTrxEntry, (contract_id))
	FC_REFLECT(dfdcore::consensus::ContractTemplateEntry, (code)(delegate_pubkey))
