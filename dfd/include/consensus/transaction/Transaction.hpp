...
namespace dfdcore {
    namespace consensus {
        ...
        struct DfdTrxidBalance
        {
            DfdTrxidBalance(){};
            DfdTrxidBalance(string dfd_account, TransactionIdType trx_id, Asset asset_trx, uint32_t
            ...
            friend bool operator > (const DfdTrxidBalance& uba, const DfdTrxidBalance& ubb){
        ...
        struct DfdBalanceEntry
        {
            std::set<TransactionIdType> dfd_trxid_sort;
            std::multimap<uint32_t, DfdTrxidBalance> dfd_block_sort;
        };
...
FC_REFLECT_ENUM(dfdcore::consensus::TransactionType,
    (normal_transaction)
    ...
    FC_REFLECT_ENUM(dfdcore::consensus::ResultTransactionType,
    (origin_transaction)
    (complete_result_transaction)
    (incomplete_result_transaction)
    )

    FC_REFLECT(dfdcore::consensus::DfdTrxidBalance, (dfd_account)(trx_id)(asset_trx)(block_num)(from_account)(create_time))
    FC_REFLECT(dfdcore::consensus::DfdBalanceEntry, (dfd_trxid_sort)(dfd_block_sort))
    FC_REFLECT(dfdcore::consensus::Transaction, (expiration)(reserved)(dfd_account)(dfd_inport_asset)(operations)(result_trx_type)(result_trx_id))
    FC_REFLECT_DERIVED(dfdcore::consensus::SignedTransaction, (dfdcore::consensus::Transaction), (signatures))
    FC_REFLECT(dfdcore::consensus::TransactionLocation, (block_num)(trx_num))
