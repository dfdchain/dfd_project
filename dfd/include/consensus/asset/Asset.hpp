...
namespace dfdcore {
    namespace consensus {
        ...
        struct Price
        {
            ...
            fc::uint128_t ratio; // This is a DECIMAL FRACTION with denominator equal to DFD_PRICE_PRECISIONI
         ...
         *  denominator.  Therefore  dfdcore/usd and  usd/dfdcore will
         *  always result in a price measured in usd/dfdcore because
         ...
         *
         *  ie:  p = 3 usd/dfdcore & a = 4 dfdcore then result = 12 usd
         *  ie:  p = 3 usd/dfdcore & a = 4 usd then result = 1.333 dfdcore
         */
...
namespace fc
{
    //  void to_variant( const dfdcore::consensus::asset& var,  variant& vo );
    //  void from_variant( const variant& var,  dfdcore::consensus::asset& vo );
    void to_variant(const dfdcore::consensus::Price& var, variant& vo);
    void from_variant(const variant& var, dfdcore::consensus::Price& vo);
}

#include <fc/reflect/reflect.hpp>
FC_REFLECT(dfdcore::consensus::Price, (ratio)(quote_asset_id)(base_asset_id));
FC_REFLECT(dfdcore::consensus::Asset, (amount)(asset_id));
