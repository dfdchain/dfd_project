    ...
    namespace consensus {
        ...
        public:
            ...
            */
			...
			vector<dfdcore::consensus::SimulatorAccountInfo>                     _vec_wallet_accounts;
...
FC_REFLECT(dfdcore::consensus::PendingChainState,
	...
	FC_REFLECT(dfdcore::consensus::SimulatorAccountInfo, (id)(name)(delegate_info)(owner_address)(registration_date)(last_update)(owner_key))
