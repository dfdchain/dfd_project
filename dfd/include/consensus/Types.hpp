...
FC_REFLECT(dfdcore::consensus::PublicKeyType, (key_data))
FC_REFLECT(dfdcore::consensus::PublicKeyType::BinaryKey, (data)(check));
FC_REFLECT_ENUM(dfdcore::consensus::BlockchainSecurityState::alert_level_enum, (green)(yellow)(red)(grey));
FC_REFLECT(dfdcore::consensus::BlockchainSecurityState, (alert_level)(estimated_confirmation_seconds)(participation_rate))
