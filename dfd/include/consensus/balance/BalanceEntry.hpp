...
FC_REFLECT(dfdcore::consensus::SnapshotEntry, (original_address)(original_balance))
FC_REFLECT(dfdcore::consensus::BalanceEntry, (condition)(balance)(restricted_owner)(snapshot_info)(deposit_date)(last_update)(meta_data))
