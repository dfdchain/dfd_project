...
FC_REFLECT(dfdcore::consensus::CreateAssetOperation,
    (symbol)
    (name)
    (description)
    (public_data)
    ...
    FC_REFLECT(dfdcore::consensus::UpdateAssetOperation,
    (asset_id)
    (name)
    (description)
    (public_data)
    ...
    FC_REFLECT_DERIVED(dfdcore::consensus::UpdateAssetExtOperation,
    (dfdcore::consensus::UpdateAssetOperation),
    (flags)
    (issuer_permissions)
    (issuer_account_id)
    (transaction_fee)
    ...
    FC_REFLECT(dfdcore::consensus::IssueAssetOperation,
    (amount)
    )
