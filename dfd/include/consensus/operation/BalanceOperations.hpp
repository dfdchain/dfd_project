...
FC_REFLECT_ENUM(dfdcore::consensus::DepositContractType, (deposit_contract_normal)(deposit_contract_margin))
FC_REFLECT(dfdcore::consensus::DepositContractOperation, (amount)(condition))
FC_REFLECT(dfdcore::consensus::WithdrawOperation, (balance_id)(amount)(claim_input_data))
FC_REFLECT(dfdcore::consensus::DepositOperation, (amount)(condition))
FC_REFLECT(dfdcore::consensus::WithdrawContractOperation, (balance_id)(amount)(contract))
FC_REFLECT(dfdcore::consensus::BalancesWithdrawOperation, (balances))
FC_REFLECT(dfdcore::consensus::ReleaseEscrowOperation, (escrow_id)(released_by)(amount_to_receiver)(amount_to_sender))
FC_REFLECT(dfdcore::consensus::UpdateBalanceVoteOperation, (balance_id)(new_restricted_owner)(new_slate))
