...
FC_REFLECT(dfdcore::consensus::UpgradeContractOperation, (id)(name)(desc)(exec_limit)(transaction_fee)(balances))
FC_REFLECT(dfdcore::consensus::DestroyContractOperation, (id)(exec_limit)(transaction_fee)(balances))
FC_REFLECT(dfdcore::consensus::OnDestroyOperation, (id)(amount))
FC_REFLECT(dfdcore::consensus::OnUpgradeOperation, (id)(name)(desc))
FC_REFLECT(dfdcore::consensus::OnCallSuccessOperation, )
FC_REFLECT(dfdcore::consensus::RegisterContractOperation, (contract_code)(initcost)(transaction_fee)(balances)(owner)(register_time))
FC_REFLECT(dfdcore::consensus::CallContractOperation, (caller)(balances)(contract)(costlimit)(transaction_fee)(method)(args))
FC_REFLECT(dfdcore::consensus::ContractInfoOperation, (contract_id)(owner)(code)(register_time))
FC_REFLECT(dfdcore::consensus::TransferContractOperation, (from)(costlimit)(transaction_fee)(transfer_amount)(balances)(contract_id))
