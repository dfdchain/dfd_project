...
FC_REFLECT(dfdcore::consensus::RegisterAccountOperation, (name)(public_data)(owner_key)(active_key)(delegate_pay_rate)(meta_data))
FC_REFLECT(dfdcore::consensus::UpdateAccountOperation, (account_id)(public_data)(active_key)(delegate_pay_rate))
FC_REFLECT(dfdcore::consensus::WithdrawPayOperation, (amount)(account_id))
FC_REFLECT(dfdcore::consensus::UpdateSigningKeyOperation, (account_id)(signing_key))
