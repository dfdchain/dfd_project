...
FC_REFLECT_ENUM(dfdcore::api::MethodPrerequisites, (no_prerequisites)(json_authenticated)(wallet_open)(wallet_unlocked)(connected_to_network)(simulator_open))
FC_REFLECT_ENUM(dfdcore::api::ParameterClassification, (required_positional)(required_positional_hidden)(optional_positional)(optional_named))
FC_REFLECT(dfdcore::api::ParameterData, (name)(type)(classification)(default_value))
FC_REFLECT(dfdcore::api::MethodData, (name)(description)(return_type)(parameters)(prerequisites)(detailed_description)(aliases)(cached))
