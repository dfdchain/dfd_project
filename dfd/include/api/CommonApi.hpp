...
namespace dfdcore {
    namespace api {
        ...
        public:
            ...
            /**
             * fetch all DfdTrxidBalance from block where blocknum of the block lower than block_num or equal to
             * block_num.
             *
             * @param block_num (uint32_t, required)
             *
             * @return vector<dfd_trxid_balance>
             */
            virtual std::vector<dfdcore::consensus::DfdTrxidBalance> blockchain_get_dfd_account_balance_entry(uint32_t block_num) = 0;
            /**
             ...
             * @return asset
             */
            virtual dfdcore::consensus::Asset blockchain_calculate_supply(const std::string& asset) const = 0;
            /**
             ...
             */
            virtual dfdcore::consensus::BlockchainSecurityState blockchain_get_security_state() const = 0;
            /**
             ...
             */
            virtual std::vector<dfdcore::consensus::AccountEntry> blockchain_list_accounts(const std::string& first_account_name = fc::json::from_string("\"\"").as<std::string>(), uint32_t limit = fc::json::from_string("20").as<uint32_t>()) const = 0;
            /**
             * Returns a list of recently updated accounts.
             *
             * @return account_entry_array
             */
            virtual std::vector<dfdcore::consensus::AccountEntry> blockchain_list_recently_updated_accounts() const = 0;
            /**
             * Returns a list of recently registered accounts.
             *
             * @return account_entry_array
             */
            virtual std::vector<dfdcore::consensus::AccountEntry> blockchain_list_recently_registered_accounts() const = 0;
            /**
             ...
             */
            virtual std::vector<dfdcore::consensus::AssetEntry> blockchain_list_assets(const std::string& first_symbol = fc::json::from_string("\"\"").as<std::string>(), uint32_t limit = fc::json::from_string("20").as<uint32_t>()) const = 0;
            /**
             * Return a list of transactions that are not yet in a block.
             *
             * @return signed_transaction_pair_array
             */
            virtual std::vector<std::pair<dfdcore::consensus::TransactionIdType, dfdcore::consensus::SignedTransaction>> blockchain_list_pending_transactions() const = 0;
            /**
             ...
             */
            virtual std::pair<dfdcore::consensus::TransactionIdType, dfdcore::consensus::TransactionEntry> blockchain_get_transaction(const std::string& transaction_id_prefix, bool exact = fc::json::from_string("false").as<bool>()) const = 0;
            /**
             ...
             */
            virtual dfdcore::wallet::PrettyTransaction blockchain_get_pretty_transaction(const std::string& transaction_id_prefix, bool exact = fc::json::from_string("false").as<bool>()) const = 0;
            /**
             ...
             */
            virtual dfdcore::wallet::PrettyContractTransaction blockchain_get_pretty_contract_transaction(const std::string& transaction_id_prefix, bool exact = fc::json::from_string("false").as<bool>()) const = 0;
            /**
             ...
             * @return oblock_entry
             */
            virtual fc::optional<dfdcore::consensus::BlockEntry> blockchain_get_block(const std::string& block) const = 0;
            /**
             ...
             */
            virtual std::map<dfdcore::consensus::TransactionIdType, dfdcore::consensus::TransactionEntry> blockchain_get_block_transactions(const std::string& block) const = 0;
            /**
             ...
             */
            virtual fc::optional<dfdcore::consensus::AccountEntry> blockchain_get_account(const std::string& account) const = 0;
            /**
             ...
             */
            virtual std::map<dfdcore::consensus::AccountIdType, std::string> blockchain_get_slate(const std::string& slate) const = 0;
            /**
             ...
             */
            virtual dfdcore::consensus::BalanceEntry blockchain_get_balance(const dfdcore::consensus::Address& balance_id) const = 0;
            /**
             ...
             */
            virtual std::unordered_map<dfdcore::consensus::BalanceIdType, dfdcore::consensus::BalanceEntry> blockchain_list_balances(const std::string& first_balance_id = fc::json::from_string("\"\"").as<std::string>(), uint32_t limit = fc::json::from_string("20").as<uint32_t>()) const = 0;
            /**
             ...
             * @return balance_entry_map
             */
            virtual std::unordered_map<dfdcore::consensus::BalanceIdType, dfdcore::consensus::BalanceEntry> blockchain_list_address_balances(const std::string& addr, const fc::time_point& chanced_since = fc::json::from_string("\"1970-1-1T00:00:01\"").as<fc::time_point>()) const = 0;
            /**
             ...
             */
            virtual dfdcore::wallet::AccountBalanceSummaryType blockchain_get_account_public_balance(const std::string& account_name) const = 0;
            /**
             ...
             * @return balance_entry_map
             */
            virtual std::unordered_map<dfdcore::consensus::BalanceIdType, dfdcore::consensus::BalanceEntry> blockchain_list_key_balances(const dfdcore::consensus::PublicKeyType& key) const = 0;
            /**
             ...
             */
            virtual fc::optional<dfdcore::consensus::AssetEntry> blockchain_get_asset(const std::string& asset) const = 0;
            /**
             ...
             * @return account_entry_array
             */
            virtual std::vector<dfdcore::consensus::AccountEntry> blockchain_list_active_delegates(uint32_t first = fc::json::from_string("0").as<uint32_t>(), uint32_t count = fc::json::from_string("20").as<uint32_t>()) const = 0;
            /**
             ...
             * @return account_entry_array
             */
            virtual std::vector<dfdcore::consensus::AccountEntry> blockchain_list_delegates(uint32_t first = fc::json::from_string("0").as<uint32_t>(), uint32_t count = fc::json::from_string("20").as<uint32_t>()) const = 0;
            /**
             ...
             */
            virtual std::vector<dfdcore::consensus::BlockEntry> blockchain_list_blocks(uint32_t max_block_num = fc::json::from_string("-1").as<uint32_t>(), uint32_t limit = fc::json::from_string("20").as<uint32_t>()) = 0;
            /**
             ...
             * @return string
             */
            virtual std::string blockchain_export_fork_graph(uint32_t start_block = fc::json::from_string("1").as<uint32_t>(), uint32_t end_block = fc::json::from_string("-1").as<uint32_t>(), const dfdcore::consensus::FilePath& filename = fc::json::from_string("\"\"").as<dfdcore::consensus::FilePath>()) const = 0;
            /**
             * returns a list of all blocks for which there is a fork off of the main chain.
             *
             * @return map<uint32_t, vector<fork_entry>>
             */
            virtual std::map<uint32_t, std::vector<dfdcore::consensus::ForkEntry>> blockchain_list_forks() const = 0;
            /**
             ...
             */
            virtual std::vector<dfdcore::consensus::SlotEntry> blockchain_get_delegate_slot_entrys(const std::string& delegate_name, uint32_t limit = fc::json::from_string("\"10\"").as<uint32_t>()) const = 0;
            /**
             ...
             * @return asset
             */
            virtual dfdcore::consensus::Asset blockchain_unclaimed_genesis() const = 0;
            /**
             ...
             */
            virtual void blockchain_broadcast_transaction(const dfdcore::consensus::SignedTransaction& trx) = 0;
            /**
             * Convert bitcoin address file to dfdcore address file.
             *
             ...
             */
            virtual dfdcore::consensus::TransactionIdType network_broadcast_transaction(const dfdcore::consensus::SignedTransaction& transaction_to_broadcast) = 0;
            /**
             ...
             */
            virtual dfdcore::network::MessagePropagationData network_get_transaction_propagation_data(const dfdcore::consensus::TransactionIdType& transaction_id) = 0;
            /**
             ...
             * @return message_propagation_data
             */
            virtual dfdcore::network::MessagePropagationData network_get_block_propagation_data(const dfdcore::consensus::BlockIdType& block_hash) = 0;
            /**
             ...
             */
            virtual std::vector<dfdcore::network::PotentialPeerEntry> network_list_potential_peers() const = 0;
            /**
             ...
             */
            virtual void delegate_blacklist_add_transaction(const dfdcore::consensus::TransactionIdType& id) = 0;
            /**
             * Remove specified transaction from blacklist.
             *
             * @param id transaction to remove from blacklist (transaction_id, required)
             */
            virtual void delegate_blacklist_remove_transaction(const dfdcore::consensus::TransactionIdType& id) = 0;
            /**
             * Add specified operation to blacklist.
             *
             * @param id operation to add to blacklist (operation_type, required)
             */
            virtual void delegate_blacklist_add_operation(const dfdcore::consensus::OperationTypeEnum& id) = 0;
            /**
             * Remove specified operation from blacklist.
             *
             * @param id operation to remove from blacklist (operation_type, required)
             */
            virtual void delegate_blacklist_remove_operation(const dfdcore::consensus::OperationTypeEnum& id) = 0;
            /**
             ...
             */
            virtual std::vector<dfdcore::wallet::PrettyTransaction> wallet_account_transaction_history(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>(), const std::string& asset_symbol = fc::json::from_string("\"\"").as<std::string>(), int32_t limit = fc::json::from_string("0").as<int32_t>(), uint32_t start_block_num = fc::json::from_string("0").as<uint32_t>(), uint32_t end_block_num = fc::json::from_string("-1").as<uint32_t>()) const = 0;
            /**
             * Lists transaction history for the specified account.
             *
             * @param account_name the name of the account for which the transaction history will be returned, "" for
             ...
             * @return pretty_transactions
             */
            virtual std::vector<dfdcore::wallet::PrettyTransaction> wallet_transaction_history_splite(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>(), const std::string& asset_symbol = fc::json::from_string("\"\"").as<std::string>(), int32_t limit = fc::json::from_string("0").as<int32_t>(), int32_t transaction_type = fc::json::from_string("\"2\"").as<int32_t>()) const = 0;
            /**
             ...
             * @return account_balance_summary_type
             */
            virtual dfdcore::wallet::AccountBalanceSummaryType wallet_account_historic_balance(const fc::time_point& time, const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) const = 0;
            /**
             ...
             */
            virtual std::map<dfdcore::consensus::TransactionIdType, fc::exception> wallet_get_pending_transaction_errors(const dfdcore::consensus::FilePath& filename = fc::json::from_string("\"\"").as<dfdcore::consensus::FilePath>()) const = 0;
            /**
             ...
             * @return address
             */
            virtual dfdcore::consensus::Address wallet_account_create(const std::string& account_name, const fc::variant& private_data = fc::json::from_string("null").as<fc::variant>()) = 0;
            /**
             ...
             * @return account_entry_array
             */
            virtual std::vector<dfdcore::consensus::AccountEntry> wallet_get_all_approved_accounts(int8_t approval = fc::json::from_string("1").as<int8_t>()) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_transfer_to_public_account(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_account_name, const dfdcore::consensus::Imessage& memo_message = fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>(), const dfdcore::wallet::VoteStrategy& strategy = fc::json::from_string("\"vote_recommended\"").as<dfdcore::wallet::VoteStrategy>()) = 0;
            /**
             *
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_get_transaction(const std::string& transaction_id) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_scan_transaction(const std::string& transaction_id, bool overwrite_existing = fc::json::from_string("false").as<bool>()) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_account_update_registration(const std::string& account_name, const std::string& pay_from_account, const fc::variant& public_data = fc::json::from_string("null").as<fc::variant>(), uint8_t delegate_pay_rate = fc::json::from_string("-1").as<uint8_t>()) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_account_update_active_key(const std::string& account_to_update, const std::string& pay_from_account, const std::string& new_active_key = fc::json::from_string("\"\"").as<std::string>()) = 0;
            /**
             * Lists all accounts associated with this wallet.
             *
             * @return wallet_account_entry_array
             */
            virtual std::vector<dfdcore::wallet::WalletAccountEntry> wallet_list_accounts() const = 0;
            /**
             * Lists all unregistered accounts belonging to this wallet.
             *
             * @return wallet_account_entry_array
             */
            virtual std::vector<dfdcore::wallet::WalletAccountEntry> wallet_list_unregistered_accounts() const = 0;
            /**
             * Lists all accounts for which we have a private key in this wallet.
             *
             * @return wallet_account_entry_array
             */
            virtual std::vector<dfdcore::wallet::WalletAccountEntry> wallet_list_my_accounts() const = 0;
            /**
             ...
             */
            virtual std::vector<dfdcore::wallet::AccountAddressData> wallet_list_my_addresses() const = 0;
            /**
             * Get the account entry for a given name.
             *
             ...
             */
            virtual dfdcore::wallet::WalletAccountEntry wallet_get_account(const std::string& account_name) const = 0;
            /**
             * Get the account entry for a given name.
             *
             * @param account_name the name of the account whose public address you want (account_name, required)
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_asset_create(const std::string& symbol, const std::string& asset_name, const std::string& issuer_name, const std::string& description, const std::string& maximum_share_supply, uint64_t precision, const fc::variant& public_data = fc::json::from_string("null").as<fc::variant>(), bool is_market_issued = fc::json::from_string("false").as<bool>()) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_asset_issue(const std::string& amount, const std::string& symbol, const std::string& to_account_name, const dfdcore::consensus::Imessage& memo_message = fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>()) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_asset_issue_to_addresses(const std::string& symbol, const std::map<std::string, dfdcore::consensus::ShareType>& addresses) = 0;
            /**
             ...
             * @return account_balance_summary_type
             */
            virtual dfdcore::wallet::AccountBalanceSummaryType wallet_account_balance(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) const = 0;
            /**
             ...
             */
            virtual dfdcore::wallet::AccountBalanceIdSummaryType wallet_account_balance_ids(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) const = 0;
            /**
             ...
             */
            virtual std::vector<dfdcore::wallet::PublicKeySummary> wallet_account_list_public_keys(const std::string& account_name) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_delegate_withdraw_pay(const std::string& delegate_name, const std::string& to_account_name, const std::string& amount_to_withdraw) = 0;
            /**
             ...
             */
            virtual dfdcore::consensus::DelegatePaySalary wallet_delegate_pay_balance_query(const std::string& delegate_name) = 0;
            /**
             * query delegate's pay balance.
             *
             * @return delegate_salary_map
             */
            virtual std::map<std::string,dfdcore::consensus::DelegatePaySalary> wallet_active_delegate_salary() = 0;
            /**
             ...
             * @return asset
             */
            virtual dfdcore::consensus::Asset wallet_set_transaction_fee(const std::string& fee) = 0;
            /**
             * Returns .
             *
             ...
             * @return asset
             */
            virtual dfdcore::consensus::Asset wallet_get_transaction_fee(const std::string& symbol = fc::json::from_string("\"\"").as<std::string>()) = 0;
            /**
             ...
             * @return optional_string
             */
            virtual fc::optional<std::string> wallet_dump_account_private_key(const std::string& account_name, const dfdcore::wallet::AccountKeyType& key_type) const = 0;
            /**
             ...
             */
            virtual dfdcore::wallet::AccountVoteSummaryType wallet_account_vote_summary(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) const = 0;
            /**
             ...
             * @return vote_summary
             */
            virtual dfdcore::wallet::VoteSummary wallet_check_vote_status(const std::string& account) = 0;
            /**
            ...
            /**
             * Initiates the login procedure by providing a Dfd Login URL.
             *
             ...
             * @return variant
             */
            virtual fc::variant wallet_login_finish(const dfdcore::consensus::PublicKeyType& server_key, const dfdcore::consensus::PublicKeyType& client_key, const fc::ecc::compact_signature& client_signature) = 0;
            /**
             ...
             * @return transaction_builder
             */
            virtual dfdcore::wallet::TransactionBuilder wallet_balance_set_vote_info(const dfdcore::consensus::Address& balance_id, const std::string& voter_address = fc::json::from_string("\"\"").as<std::string>(), const dfdcore::wallet::VoteStrategy& strategy = fc::json::from_string("\"vote_all\"").as<dfdcore::wallet::VoteStrategy>(), bool sign_and_broadcast = fc::json::from_string("\"true\"").as<bool>(), const std::string& builder_path = fc::json::from_string("\"\"").as<std::string>()) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_publish_slate(const std::string& publishing_account_name, const std::string& paying_account_name = fc::json::from_string("\"\"").as<std::string>()) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_publish_version(const std::string& publishing_account_name, const std::string& paying_account_name = fc::json::from_string("\"\"").as<std::string>()) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_collect_genesis_balances(const std::string& account_name) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_account_retract(const std::string& account_to_retract, const std::string& pay_from_account) = 0;
            /**
             ...
             * @return public_key
             */
            virtual dfdcore::consensus::PublicKeyType wallet_get_account_owner_publickey(const std::string& account_name) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_transfer_to_contract(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract, double amount_for_exec) = 0;
            /**
             ...
             * @return asset_array
             */
            virtual std::vector<dfdcore::consensus::Asset> wallet_transfer_to_contract_testing(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract) = 0;
            /**
             ...
             * @return transaction_builder
             */
            virtual dfdcore::wallet::TransactionBuilder wallet_builder_add_signature(const dfdcore::wallet::TransactionBuilder& builder, bool broadcast = fc::json::from_string("false").as<bool>()) = 0;
            /**
             ...
             * @return transaction_builder
             */
            virtual dfdcore::wallet::TransactionBuilder wallet_builder_file_add_signature(const dfdcore::consensus::FilePath& builder_path, bool broadcast = fc::json::from_string("false").as<bool>()) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_multisig_deposit(const std::string& amount, const std::string& asset_symbol, const std::string& from_account, const std::string& to_account, const dfdcore::consensus::Imessage& memo_message = fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>()) = 0;
            /**
             ...
             * @return variant_object
             */
            virtual fc::variant_object wallet_import_multisig_account(const dfdcore::consensus::Address& multisig_address) = 0;
            /**
             ...
             * @return address
             */
            virtual dfdcore::consensus::Address wallet_import_multisig_account_by_detail(const std::string& asset_symbol, uint32_t m, const std::vector<dfdcore::consensus::Address>& addresses) = 0;
            /**
             ...
             * @return transaction_builder
             */
            virtual dfdcore::wallet::TransactionBuilder wallet_multisig_withdraw_start(const std::string& amount, const std::string& asset_symbol, const dfdcore::consensus::Address& from, const dfdcore::consensus::Address& to_address, const dfdcore::consensus::Imessage& memo_message = fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>(), const dfdcore::consensus::FilePath& builder_path = fc::json::from_string("\"\"").as<dfdcore::consensus::FilePath>()) = 0;
            /**
             * transfer to multisig account.
             *
             * @param amount how much to transfer (string, required) (string, required)
             ...
             */
            virtual std::pair<std::string, dfdcore::wallet::WalletTransactionEntry> wallet_create_multisig_account(const std::string& amount, const std::string& asset_symbol, const std::string& from_account, uint32_t m, const std::vector<dfdcore::consensus::Address>& addresses, const dfdcore::consensus::Imessage& memo_message = fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>()) = 0;
            /**
             ...
             * @return pretty_transactions
             */
            virtual std::vector<dfdcore::wallet::PrettyTransaction> wallet_multisig_account_history(const std::string& account_address, const std::string& asset_symbol = fc::json::from_string("\"\"").as<std::string>(), int32_t limit = fc::json::from_string("0").as<int32_t>(), uint32_t start_block_num = fc::json::from_string("0").as<uint32_t>(), uint32_t end_block_num = fc::json::from_string("-1").as<uint32_t>()) const = 0;
            /**
             * Lists the total asset balances for the specified account.
             *
             ...
             * @return account_balance_summary_type
             */
            virtual dfdcore::wallet::AccountBalanceSummaryType wallet_multisig_account_balance(const std::string& account_address = fc::json::from_string("\"\"").as<std::string>()) const = 0;
            /**
             ...
             * @return variant_object
             */
            virtual fc::variant_object wallet_builder_get_multisig_detail(const dfdcore::wallet::TransactionBuilder& transaction_builder) const = 0;
            /**
             * get builder signature details.
             *
             * @param builder_path builder_path If specified, will write builder here instead of to
             ...
             * @return variant_object
             */
            virtual fc::variant_object wallet_builder_file_get_multisig_detail(const dfdcore::consensus::FilePath& builder_path) const = 0;
            /**
            ...
            /**
             * Return information about given Dfd address.
             *
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry builder_finalize_and_sign(const dfdcore::wallet::TransactionBuilder& builder) const = 0;
            /**
             * Returns help information as JSON data.
             *
             * @return method_map_type
             */
            virtual std::map<std::string, dfdcore::api::MethodData> meta_help() const = 0;
            /**
             ...
             * @return asset_array
             */
            virtual std::vector<dfdcore::consensus::Asset> contract_register_testing(const std::string& owner, const fc::path& codefile) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry contract_upgrade(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const dfdcore::consensus::Imessage& new_contract_desc, const std::string& asset_symbol, const fc::optional<double>& exec_limit) = 0;
            /**
             ...
             * @return asset_array
             */
            virtual std::vector<dfdcore::consensus::Asset> contract_upgrade_testing(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const dfdcore::consensus::Imessage& new_contract_desc) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry contract_destroy(const std::string& contract_address, const std::string& destroyer_name, const std::string& asset_symbol, const fc::optional<double>& exec_limit) = 0;
            /**
             ...
             * @return asset_array
             */
            virtual std::vector<dfdcore::consensus::Asset> contract_destroy_testing(const std::string& contract_address, const std::string& destroyer_name) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry contract_call(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params, const std::string& asset_symbol, const fc::optional<double>& call_limit) = 0;
            /**
             ...
             */
            virtual dfdcore::consensus::ContractEntryPrintable contract_get_info(const std::string& contract) = 0;
            /**
             ...
             */
            virtual std::vector<dfdcore::consensus::BalanceEntry> contract_get_balance(const std::string& contract) = 0;
            /**
             ...
             * @return asset_array
             */
            virtual std::vector<dfdcore::consensus::Asset> contract_call_testing(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params) = 0;
            /**
             ...
             * @return contract_entry_printable
             */
            virtual dfdcore::consensus::ContractEntryPrintable contract_load_to_file(const std::string& contract, const fc::path& file) = 0;
            /**
             ...
             * @return transaction_id
             */
            virtual dfdcore::consensus::TransactionIdType get_result_trx_id(const dfdcore::consensus::TransactionIdType& request_id) = 0;
            /**
             ...
             * @return transaction_id
             */
            virtual dfdcore::consensus::TransactionIdType get_request_trx_id(const dfdcore::consensus::TransactionIdType& request_id) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry simulator_contract_call(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params, const std::string& cost_asset, const fc::optional<double>& callLimit) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry simulator_contract_upgrade(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const dfdcore::consensus::Imessage& new_contract_desc, const std::string& asset_symbol, const fc::optional<double>& exec_limit) = 0;
            /**
             * in simulator state: upgrade temporary contract to permanent contract.
             *
             * @param contract_address contract address need to upgrade (string, required)
             ...
             * @return asset_array
             */
            virtual std::vector<dfdcore::consensus::Asset> simulator_contract_upgrade_testing(const std::string& contract_address, const std::string& upgrader_name, const std::string& new_contract_name, const dfdcore::consensus::Imessage& new_contract_desc) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry simulator_contract_destroy(const std::string& contract_address, const std::string& destroyer_name, const std::string& asset_symbol, const fc::optional<double>& exec_limit) = 0;
            /**
             ...
             * @return asset_array
             */
            virtual std::vector<dfdcore::consensus::Asset> simulator_contract_destroy_testing(const std::string& contract_address, const std::string& destroyer_name) = 0;
            /**
             ...
             * @return contract_entry_printable
             */
            virtual dfdcore::consensus::ContractEntryPrintable simulator_contract_get_info(const std::string& contract) = 0;
            /**
             ...
             * @return balance_entry_list
             */
            virtual std::vector<dfdcore::consensus::BalanceEntry> simulator_contract_get_balance(const std::string& contract) = 0;
            /**
             ...
             * @return transaction_entry
             */
            virtual dfdcore::wallet::WalletTransactionEntry simulator_transfer_to_contract(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract, double amount_for_exec) = 0;
            /**
             ...
             * @return account_balance_summary_type
             */
            virtual dfdcore::wallet::AccountBalanceSummaryType simulator_account_balance(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) = 0;
            /**
             ...
             * @return contract_entry_printable
             */
            virtual dfdcore::consensus::ContractEntryPrintable simulator_contract_load_to_file(const std::string& contract, const fc::path& file) = 0;
            /**
             ...
             * @return asset_array
             */
            virtual std::vector<dfdcore::consensus::Asset> simulator_contract_register_testing(const std::string& owner, const fc::path& codefile) = 0;
            /**
             ...
             * @return asset_array
             */
            virtual std::vector<dfdcore::consensus::Asset> simulator_contract_call_testing(const std::string& contract, const std::string& caller_name, const std::string& function_name, const std::string& params) = 0;
            /**
             ...
             * @return asset_array
             */
            virtual std::vector<dfdcore::consensus::Asset> simulator_transfer_to_contract_testing(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_name, const std::string& to_contract) = 0;
            /**
             ...
             */
            virtual vector<dfdcore::consensus::SimulatorAccountInfo> simulator_list_my_addresses(const std::string& account_name = fc::json::from_string("\"\"").as<std::string>()) = 0;
            /**
             ...
             * @return string
             */
            virtual std::string get_contract_registered_in_transaction(const dfdcore::consensus::TransactionIdType& trx_id) = 0;
            /**
             ...
             * @return transaction_id
             */
            virtual dfdcore::consensus::TransactionIdType get_transaction_id_contract_registered(const std::string& contract_id) = 0;
            /**
             ...
             */
            virtual dfdcore::consensus::CodePrintAble contract_get_info_from_gpc_file(const fc::path& file) = 0;
            /**
             ...
             * @return string
             */
            virtual std::string script_add(const fc::path& filename, const dfdcore::consensus::Imessage& description) = 0;
            /**
             ...
             */
            virtual dfdcore::wallet::ScriptEntryPrintable script_get_info(const std::string& scriptid) = 0;
            /**
             * List all scripts in database .
             *
             * @return scriptentry_printable_list
             */
            virtual std::vector<dfdcore::wallet::ScriptEntryPrintable> scripts_list() = 0;
            /**
            ...
            * @return transaction_entry
            */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_transfer_to_address_build(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_public_key, const std::string& to_address, const dfdcore::consensus::Imessage& memo_message = fc::json::from_string("\"\"").as<dfdcore::consensus::Imessage>(), const dfdcore::wallet::VoteStrategy& strategy = fc::json::from_string("\"vote_none\"").as<dfdcore::wallet::VoteStrategy>()) = 0;
            ...
            * @return transaction_entry
            */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_transfer_to_contract_build(const std::string& amount_to_transfer, const std::string& asset_symbol, const std::string& from_account_public_key, const std::string& to_contract, double amount_for_exec) = 0;
            ...
            * @return transaction_entry
            */
            virtual dfdcore::wallet::WalletTransactionEntry wallet_call_contract_build(const std::string& contract, const std::string& caller_publickey, const std::string& function_name, const std::string& params, const std::string& asset_symbol, const fc::optional<double>& call_limit) = 0;
            ...
            * @return transaction_entry
            */
            virtual dfdcore::wallet::WalletTransactionEntry sign_build_transaction(const dfdcore::wallet::WalletTransactionEntry& trasaction_building) = 0;
            /**
            ...
            * @return std::string
            */
            virtual std::string broadcast_building_transaction(const dfdcore::wallet::WalletTransactionEntry& trasaction_building) = 0;


        };

    }
} // end namespace dfdcore::api
